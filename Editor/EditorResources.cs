...
namespace PancakeEditor
{
    internal static class EditorResources
    {
        ...
        internal static Texture2D ScriptableSetting => Editor.FindAssetWithPath<Texture2D>("scriptable_setting.png", RELATIVE_PATH);
        ...
        internal static Texture2D ScriptableOdin => Editor.FindAssetWithPath<Texture2D>("scriptable_odin.png", RELATIVE_PATH);
