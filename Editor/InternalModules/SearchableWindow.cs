...
namespace Pancake.Editor
{
    public sealed class SearchableWindow : EditorWindow
    {
        ...
        private void OnBackgroundGUI()
        {
            ...
            GUI.Box(boxPosition, GUIContent.none, Uniform.Header);
        }
        ...
        private void OnSearchFieldGUI()
        {
            ...
            GUI.Box(new Rect(toolbarPosition.x - 5, toolbarPosition.y - 4, toolbarPosition.width, 23), GUIContent.none, Uniform.Header);
            ...
            if (GUI.Button(new Rect(toolbarPosition.xMax - 13, toolbarPosition.y - 4, 26, 23), EditorGUIUtility.IconContent("winbtn_win_close"), Uniform.ActionButton))
            {
                searchText = string.Empty;
