...
namespace Pancake.UI.Editor
{
    public class SnapAnchorsWindow : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            switch (_mode)
            {
                case AnchorMode.Border:
                {
                    ...
                    if (GUILayout.Button(new GUIContent(EditorResources.SnapAllBorder, "Snap to all borders"), GUILayout.Width(120), GUILayout.Height(120)))
                        SnapBorder(left: true, right: true, top: true, bottom: true);


                    // TOP DOWN
                    if (GUILayout.Button(new GUIContent(EditorResources.SnapVerticalBorder, "Snap to top and bottom border"), GUILayout.Width(60), GUILayout.Height(120)))
        ...
        private void DrawPointButtons()
        {
            ...
            if (GUILayout.Button(new GUIContent(EditorResources.SnapAllPoint, "Snap all directions to position"), GUILayout.Width(120), GUILayout.Height(100)))
                SnapPoint(horizontal: true, vertical: true);

            // TOP DOWN
            if (GUILayout.Button(new GUIContent(EditorResources.SnapVerticalPoint, "Snap vertically to position"), GUILayout.Width(60), GUILayout.Height(100)))
            ...
            // LEFT RIGHT
            if (GUILayout.Button(new GUIContent(EditorResources.SnapHorizontalPoint, "Snap horizontally to position"), GUILayout.Width(120), GUILayout.Height(60)))
