...
namespace Pancake.Editor.Finder
{
    ...
    {
        [NonSerialized] private static Dictionary<string, AssetInfo> pathToAssetInfo;

        static ProjectFinder()
        {
            pathToAssetInfo = new Dictionary<string, AssetInfo>();
            var assetInfos = ProjectFinderData.AssetInfos;
        ...
        {
            pathToAssetInfo.TryGetValue(path, out var assetInfo);
            return assetInfo;
        }
        ...
        public static void ClearDatabase() { pathToAssetInfo.Clear(); }
        ...
        public static void RebuildDatabase()
        {
            ...
            ProjectFinderData.IsUpToDate = true;
        ...
        public static void SaveDatabase()
        {
            ...
            ProjectFinderData.AssetInfos = assetInfos;
            ProjectFinderData.Save();
        }
    }
}