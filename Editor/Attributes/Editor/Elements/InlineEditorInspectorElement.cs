...
namespace PancakeEditor.Attribute
{
    public class InlineEditorInspectorElement : InspectorElement
    {
        ...
        public InlineEditorInspectorElement(Property property)
        {
            _property = property;
        ...
        public override void OnGUI(Rect position)
        {
            ...
            if (Event.current.type == EventType.Repaint && !Mathf.Approximately(_editorPosition.height, lastEditorRect.height))
            {
