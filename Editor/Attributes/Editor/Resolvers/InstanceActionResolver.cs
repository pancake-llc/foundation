...
namespace Pancake.AttributeDrawer
{
    internal sealed class InstanceActionResolver : ActionResolver
    {
        ...
        public static bool TryResolve(PropertyDefinition propertyDefinition, string method, out ActionResolver resolver)
        {
            ...
            {
                if (methodInfo.Name == method && methodInfo.ReturnType == typeof(void) && methodInfo.GetParameters() is var parameterInfos && parameterInfos.Length == 0)
                {
        ...
        private InstanceActionResolver(MethodInfo methodInfo) { _methodInfo = methodInfo; }
