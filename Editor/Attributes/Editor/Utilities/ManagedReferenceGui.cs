...
{
    internal static class ManagedReferenceGui
    {
        public static void DrawTypeSelector(Rect rect, Property property)
        {
        ...
        private class ReferenceTypeDropDown : AdvancedDropdown
        {
            ...
            public ReferenceTypeDropDown(Property property, AdvancedDropdownState state)
                : base(state)
            {
                _property = property;
            ...
            protected override AdvancedDropdownItem BuildRoot()
            {
                ...
                {
                    IEnumerable<string> namespaceEnumerator = groupByNamespace && type.Namespace != null ? type.Namespace.Split('.') : Array.Empty<string>();
            ...
            private class ReferenceTypeGroupItem : AdvancedDropdownItem
            {
                ...
                private readonly Dictionary<string, ReferenceTypeGroupItem> _childGroups = new Dictionary<string, ReferenceTypeGroupItem>();

                public ReferenceTypeGroupItem(string name)
                    : base(name)
                {
                }
