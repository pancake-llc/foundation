    ...
    internal static class ReflectionUtilities
    {
        ...
        public static IReadOnlyList<Type> AllNonAbstractTypes
        {
            get
            {
                ...
                {
                    _allNonAbstractTypesBackingField = Assemblies.SelectMany(asm =>
                        {
                            try
                            {
                                return asm.GetTypes();
        ...
        public static IReadOnlyList<T> GetCustomAttributes<T>(this Assembly asm) { return asm.GetCustomAttributes(typeof(T)).Cast<T>().ToList(); }
        ...
        public static Type GetUnityEditorTypeByFullName(string name) { return GetTypeByFullName(name, typeof(UnityEditor.Editor).Assembly); }

        public static Type GetTypeByFullName(string name, Assembly assembly) { return assembly.GetTypes().Single(it => it.FullName == name); }
        ...
        private static IReadOnlyList<T> GetAllMembersInDeclarationOrder<T>(Type type, Func<Type, T[]> select) where T : MemberInfo
        {
