using UnityEditor;
using UnityEngine;
using FilePathAttribute = Pancake.FilePathAttribute;

namespace Pancake.Editor
{
    [ViewTarget(typeof(FilePathAttribute))]
    sealed class FilePathView : FieldView, ITypeValidationCallback
    {
        ...
        public override void OnGUI(Rect position, SerializedField serializedField, GUIContent label)
        {
            ...
            serializedField.GetSerializedProperty().stringValue = EditorGUI.TextField(stringFieldPosition, serializedField.GetSerializedProperty().stringValue);
            ...
            if (GUI.Button(buttonPosition, content, "IconButton"))
            {
                ...
                if (!string.IsNullOrEmpty(selectedPath))
                {
                    ...
                    serializedField.GetSerializedProperty().stringValue = selectedPath;
                }
            }
        }
