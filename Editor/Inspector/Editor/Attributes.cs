...
namespace Pancake.Editor
{
    ...
    {
        public RegisterTriGroupDrawerAttribute(Type drawerType) { DrawerType = drawerType; }
    ...
    {
        public RegisterTriPropertyHideProcessor(Type processorType) { ProcessorType = processorType; }
    ...
    {
        public RegisterTriPropertyDisableProcessor(Type processorType) { ProcessorType = processorType; }
    ...
    {
        public RegisterTriValueValidatorAttribute(Type validatorType) { ValidatorType = validatorType; }
    ...
    {
        public RegisterTriAttributeValidatorAttribute(Type validatorType) { ValidatorType = validatorType; }
