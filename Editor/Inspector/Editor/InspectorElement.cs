...
namespace Pancake.Editor
{
    ...
    {
        private static readonly List<InspectorElement> Empty = new List<InspectorElement>();

        private bool _attached;
        private List<InspectorElement> _children = Empty;

        [PublicAPI] public int ChildrenCount => _children.Count;
        ...
        [PublicAPI]
        public InspectorElement GetChild(int index) { return _children[index]; }
        ...
        [PublicAPI]
        public void AddChild(InspectorElement child)
        {
            if (_children == Empty)
            {
                _children = new List<InspectorElement>();
            }
