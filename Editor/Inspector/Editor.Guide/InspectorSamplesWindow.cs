namespace Pancake.Editor.Guide
{
    ...
    internal class InspectorSamplesWindow : EditorWindow
    {
        ...
        [MenuItem("Tools/Pancake/Inspector Sample")]
        ...
        private void OnDisable() { ChangeCurrentSample(null); }
        ...
        private void DrawElement()
        {
            ...
            using (var scrollScope = new GUILayout.ScrollViewScope(_currentScroll))
            {
                ...
                using (new GUILayout.VerticalScope(SampleWindowStyles.Padding))
                {
                    ...
                    using (GuiHelper.PushEditorTarget(_current))
        ...
        private void ChangeCurrentSample(Type type)
        {
            ...
            if (type != null)
            {
                ...
                _currentPropertyTree = new PropertyTreeForSerializedObject(_currentSerializedObject);
            }
        }
        ...
        private class MenuTree : TreeView
        {
            ...
            public MenuTree(TreeViewState state)
                : base(state)
            {
            }
            ...
            protected override void SelectionChanged(IList<int> selectedIds)
            {
                ...
                var type = selectedIds.Count > 0 && FindItem(selectedIds[0], rootItem) is SampleItem sampleItem ? sampleItem.Type : null;
            ...
            protected override TreeViewItem BuildRoot()
            {
                ...
                var sampleTypes = typeof(InspectorSamplesWindow).Assembly.GetTypes()
            ...
            private class SampleItem : TreeViewItem
            {
                ...
                public SampleItem(int id, Type type)
                    : base(id, 1, GetTypeNiceName(type))
                {
                    Type = type;
                }
            }
