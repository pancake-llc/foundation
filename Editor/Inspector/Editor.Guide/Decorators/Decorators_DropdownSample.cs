namespace Pancake.Editor.Guide
{
    ...
    {
        [Dropdown(nameof(_intValues))] public int intValue = 1;

        [Dropdown(nameof(GetStringValues))] public string stringValue;

        [Dropdown(nameof(GetVectorValues))] public Vector3 vectorValue;
        ...
        private IEnumerable<DropdownItem<Vector3>> GetVectorValues()
        {
