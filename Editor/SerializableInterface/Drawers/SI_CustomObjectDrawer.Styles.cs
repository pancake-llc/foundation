...
{
    public partial class SI_CustomObjectDrawer
    {
            ...
            public static GUIStyle SelectedLabelStyle
            {
                get
                {
                    if (selectedLabelStyle == null)
                    {
                        ...
                        {
                            normal = {textColor = EditorGUIUtility.isProSkin ? new Color32(128, 179, 253, 255) : new Color32(18, 73, 142, 255)},
                            hover = {textColor = EditorGUIUtility.isProSkin ? new Color32(128, 179, 253, 255) : new Color32(18, 73, 142, 255)}
                        };
                    }
