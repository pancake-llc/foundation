...
{
    internal static class SI_IconUtility
    {
        ...
        public static Texture2D GetIconForObject(string path) { return (Texture2D) AssetDatabase.GetCachedIcon(path); }

        public static Texture2D GetIconForObject(Object obj) { return EditorGUIUtility.GetIconForObject(obj); }
#else
