...
namespace PancakeEditor
{
    ...
    public sealed class InternalCustomEditorCache
    {
        ...
        internal static bool TryGetInternalEditorType(string fullTypeName, out Type result)
        {
            ...
            {
                Debug.LogError(
                    $"Type {fullTypeName} not found in the assembly {typeof(Editor).Assembly.GetName().Name}. Contact the developer in the forums to add support for your Unity version.");
                return false;
            }
