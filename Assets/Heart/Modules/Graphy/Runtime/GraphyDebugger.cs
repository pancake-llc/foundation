...
namespace Tayx.Graphy
{
    ...
    {
        private static GraphyDebugger _instance;
        private static object _lock = new object();

        public static GraphyDebugger Instance
        {
            get
            {
                lock (_lock)
                {
                    if (_instance == null)
                    {
                        Debug.Log("[Singleton] An instance of " + typeof(GraphyDebugger) + " is trying to be accessed, but it wasn't initialized first. " +
                                  "Make sure to add an instance of " + typeof(GraphyDebugger) + " in the scene before " + " trying to access it.");
                    }
        ...
        private void Awake()
        {
            ...
            else _instance = GetComponent<GraphyDebugger>();
        }
        ...
        {
            [Tooltip("Variable to compare against")] public DebugVariable Variable;

            [Tooltip("Comparer operator to use")] public DebugComparer Comparer;

            [Tooltip("Value to compare against the chosen variable")] public float Value;
        }
        ...
        {
            [Tooltip("If false, it won't be checked")] public bool Active = true;
            ...
            [Tooltip("If true, it pauses the editor")] public bool DebugBreak = false;
        ...
        private void Update() { CheckDebugPackets(); }
        ...
        /// </summary>
        public void AddNewDebugPacket(DebugPacket newDebugPacket) { m_debugPackets?.Add(newDebugPacket); }
        ...
        /// <returns></returns>
        public DebugPacket GetFirstDebugPacketWithId(int packetId) { return m_debugPackets.First(x => x.Id == packetId); }
        ...
        /// <param name="packetId"></param>
        /// <returns></returns>
        public List<DebugPacket> GetAllDebugPacketsWithId(int packetId) { return m_debugPackets.FindAll(x => x.Id == packetId); }
