...
namespace PancakeEditor
{
    internal static class OtherPackageWindow
    {
        public static void OnInspectorGUI()
        {
            ...
            Uninstall("Particle Effect For UGUI 4.8.1", "com.coffee.ui-particle");
#else
        ...
        private static void InstallParticleEffectUGUI()
        {
            ...
            {
                RegistryManager.Add("com.coffee.ui-particle", "https://github.com/mob-sakai/ParticleEffectForUGUI.git#4.8.1");
                RegistryManager.Resolve();
            }
