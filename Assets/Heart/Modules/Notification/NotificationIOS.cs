...
namespace Pancake.Notification
{
    internal static class NotificationIOS
    {
        ...
        internal static void CancelAllScheduled() { iOSNotificationCenter.RemoveAllScheduledNotifications(); }
        internal static void ClearBadgeCounter() { iOSNotificationCenter.ApplicationBadge = 0; }
    }
}
