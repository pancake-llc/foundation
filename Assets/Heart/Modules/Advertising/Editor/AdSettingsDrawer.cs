    ...
    public class AdSettingsDrawer : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(_admobAppOpenProperty, new GUIContent("App Open"));
                ...
                EditorGUILayout.BeginHorizontal();
                GUI.backgroundColor = Uniform.Green;
                if (GUILayout.Button("Install Admob SDK v8.6.0 (1)", GUILayout.Height(24)))
                {
                    ...
                    const string manifestMeta = @"fileFormatVersion: 2
...
";
                    ...
                    const string properties = "target=android-31" + "\nandroid.library=true";
...
";
                    ...
                    const string packagingOption = @"android {
    packagingOptions {
        pickFirst ""META-INF/kotlinx_coroutines_core.version""
    }
}
";
                    const string packagingOptionMeta = @"fileFormatVersion: 2
...
";
                    ...
                    const string validateDependency = @"// Copyright (C) 2023 Google LLC
//
...
";
                    const string validateDependencyMeta = @"fileFormatVersion: 2
