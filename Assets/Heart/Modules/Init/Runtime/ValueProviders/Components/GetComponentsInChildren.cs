...
{
	/// <summary>
	/// Returns all objects of the given type attached to the client's <see cref="GameObject"/> and all its children.
	/// <para>
	...
	[CreateAssetMenu(fileName = MENU_NAME, menuName = CREATE_ASSET_MENU_GROUP + MENU_NAME, order = 1007)]
	#endif
