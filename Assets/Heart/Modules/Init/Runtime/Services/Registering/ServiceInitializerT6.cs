...
namespace Sisus.Init
{
	...
	public abstract class ServiceInitializer<TService, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument> : IServiceInitializer<TService, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument> where TService : class
	{
		...
		{
			Task<TService> task = InitTargetAsync((TFirstArgument)services[0], (TSecondArgument)services[1], (TThirdArgument)services[2], (TFourthArgument)services[3], (TFifthArgument)services[4], (TSixthArgument)services[5]);
		...
		/// <inheritdoc/>
		public Task<TService> InitTargetAsync(TFirstArgument firstArgument, TSecondArgument secondArgument, TThirdArgument thirdArgument, TFourthArgument fourthArgument, TFifthArgument fifthArgument, TSixthArgument sixthArgument) => Task.FromResult(InitTarget(firstArgument, secondArgument, thirdArgument, fourthArgument, fifthArgument, sixthArgument));
	}
}