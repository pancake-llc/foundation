...
namespace Sisus.Init
{
	...
	public abstract class SerializedMonoBehaviour<TFirstArgument, TSecondArgument, TThirdArgument> : SerializedMonoBehaviour, IInitializable<TFirstArgument, TSecondArgument, TThirdArgument>, IInitializable
	{
		...
		protected object this[[DisallowNull] string memberName]
        {
			set
			{
				...
				Inject<SerializedMonoBehaviour<TFirstArgument, TSecondArgument, TThirdArgument>, TFirstArgument, TSecondArgument, TThirdArgument>(this, memberName, value);
			}
        }
