...
namespace Sisus.Init
{
	...
	public abstract class SerializedMonoBehaviour<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument> : SerializedMonoBehaviour, IInitializable<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument>, IInitializable
	{
		...
		protected object this[[DisallowNull] string memberName]
		{
			set
			{
				...
				Inject<SerializedMonoBehaviour<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument>, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument>(this, memberName, value);
			}
		}
