...
namespace Sisus.Init
{
	...
	public abstract class SerializedMonoBehaviour<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument> : SerializedMonoBehaviour, IInitializable<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument>, IInitializable
	{
		...
		protected object this[[DisallowNull] string memberName]
        {
			set
			{
				...
				Inject<SerializedMonoBehaviour<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument>, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument>(this, memberName, value);
			}
        }
