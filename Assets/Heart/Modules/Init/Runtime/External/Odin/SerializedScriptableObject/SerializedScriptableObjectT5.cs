...
namespace Sisus.Init
{
	...
	/// </para>
	/// <para>
	/// Instances of classes inheriting from <see cref="SerializedScriptableObject{TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument}"/>
	...
	public abstract class SerializedScriptableObject<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument>
		: SerializedScriptableObject, IInitializable<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument>, IInitializable
		#if UNITY_EDITOR
		...
		#endif
	{
		...
		protected object this[[DisallowNull] string memberName]
		{
			set
			{
				...
				Inject<SerializedScriptableObject<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument>, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument>(this, memberName, value);
			}
		}
