...
namespace Sisus.Init
{
	...
	/// </para>
	/// <para>
	/// Instances of classes inheriting from <see cref="SerializedScriptableObject{TFirstArgument, TSecondArgument, TThirdArgument}"/> receive the arguments
	...
	public abstract class SerializedScriptableObject<TFirstArgument, TSecondArgument, TThirdArgument> : SerializedScriptableObject, IInitializable<TFirstArgument, TSecondArgument, TThirdArgument>, IInitializable
		#if UNITY_EDITOR
		...
		#endif
	{
		...
		protected object this[[DisallowNull] string memberName]
		{
			set
			{
				...
				Inject<SerializedScriptableObject<TFirstArgument, TSecondArgument, TThirdArgument>, TFirstArgument, TSecondArgument, TThirdArgument>(this, memberName, value);
			}
		}
