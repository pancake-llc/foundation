...
namespace Sisus.Init
{
	...
	/// </para>
	/// <para>
	/// Instances of classes inheriting from <see cref="SerializedScriptableObject{TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument}"/>
	...
	public abstract class SerializedScriptableObject<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument>
		: SerializedScriptableObject, IInitializable<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument>, IInitializable
		#if UNITY_EDITOR
		...
		#endif
	{
		...
		/// <param name="fifthArgument"> The fifth object that this <see cref="SerializedScriptableObject"/> depends on. </param>
		/// <param name="sixthArgument"> The sixth object that this <see cref="SerializedScriptableObject"/> depends on. </param>
		...
		protected object this[[DisallowNull] string memberName]
		{
			set
			{
				...
				Inject<SerializedScriptableObject<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument>, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument>(this, memberName, value);
			}
		}
