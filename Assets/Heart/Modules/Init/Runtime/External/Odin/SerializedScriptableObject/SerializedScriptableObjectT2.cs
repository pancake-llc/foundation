...
namespace Sisus.Init
{
	...
	/// </para>
	/// <para>
	/// Instances of classes inheriting from <see cref="SerializedScriptableObject{TFirstArgument, TSecondArgument}"/> receive the arguments
	...
	public abstract class SerializedScriptableObject<TFirstArgument, TSecondArgument> : SerializedScriptableObject, IInitializable<TFirstArgument, TSecondArgument>, IInitializable
		#if UNITY_EDITOR
		...
		#endif
	{
		...
		protected object this[[DisallowNull] string memberName]
		{
			set
			{
				...
				Inject<SerializedScriptableObject<TFirstArgument, TSecondArgument>, TFirstArgument, TSecondArgument>(this, memberName, value);
			}
		}
