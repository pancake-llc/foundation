...
namespace Pancake.Threading.Tasks.Internal
{
    internal static class DiagnosticsExtensions
    {
        ...
        static string BeautifyType(Type t, bool shortName)
        {
            ...
            return typeBeautifyRegex.Replace(genericType, "").Replace("Pancake.Threading.Tasks.Triggers.", "").Replace("Pancake.Threading.Tasks.Internal.", "").Replace("Pancake.Threading.Tasks.", "") + "<" + innerFormat + ">";
        }
