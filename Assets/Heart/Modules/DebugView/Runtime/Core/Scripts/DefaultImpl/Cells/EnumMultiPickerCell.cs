...
namespace Pancake.DebugView
{
        ...
        protected override void SetModel(EnumMultiPickerCellModel model)
        {
            if (!_isInitialized)
            {
                ...
                foreach (Enum value in Enum.GetValues(enumType))
                {
                    ...
                    _options.Add(new Option {Name = value.ToString(), Value = intValue, IsActive = (activeIntValue & intValue) == intValue});
                }
    ...
    {
        public EnumMultiPickerCellModel(Enum activeValue) { ActiveValue = activeValue; }
