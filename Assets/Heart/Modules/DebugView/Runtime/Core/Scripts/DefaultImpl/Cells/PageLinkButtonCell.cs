...
namespace Pancake.DebugView
{
    ...
    {
        public PageLinkButtonCellModel(bool useSubTextOrIcon) { UseSubTextOrIcon = useSubTextOrIcon; }
        ...
        internal void InvokeOnLoad(string pageId, DebugPageBase debugPage) { OnLoad?.Invoke((pageId, debugPage)); }
    }
}