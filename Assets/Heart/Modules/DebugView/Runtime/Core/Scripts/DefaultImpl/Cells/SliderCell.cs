...
namespace Pancake.DebugView
{
    public sealed class SliderCell : Cell<SliderCellModel>
    {
        ...
        [SerializeField] private RectTransform containerTrans;
        ...
        protected override void SetModel(SliderCellModel model)
        {
            ...
            height += 36; // Padding
            topTrans.SetSizeWithCurrentAnchors(RectTransform.Axis.Vertical, height);
            height += 65; // Bottom is fixed size.
            containerTrans.SetSizeWithCurrentAnchors(RectTransform.Axis.Vertical, height);
            height += 1; // Border
    ...
    public sealed class SliderCellModel : CellModel
    {
        ...
        internal void InvokeValueChanged(float value) { ValueChanged?.Invoke(value); }
    }
}