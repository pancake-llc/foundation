...
namespace Pancake.DebugView
{
    ...
    {
        public int AddLabel(string text, string subText = null, Color? textColor = null, Color? subTextColor = null, Sprite icon = null, Color? iconColor = null)
        {
            ...
            return AddLabel(labelCellModel);
        }

        public int AddLabel(LabelCellModel model) { return AddItem(AssetKeys.LABEL_CELL, model); }
            ...
            Action clicked = null)
        {
            ...
            return AddButton(buttonCellModel);
        }

        public int AddButton(ButtonCellModel model) { return AddItem(AssetKeys.BUTTON_CELL, model); }

        public int AddButtonCollection(ButtonCollectionCellModel model) { return AddItem(AssetKeys.BUTTON_COLLECTION_CELL, model); }
            ...
            Action<bool> valueChanged = null)
        {
            ...
            return AddSwitch(switchCellModel);
        }

        public int AddSwitch(SwitchCellModel model) { return AddItem(AssetKeys.SWITCH_CELL, model); }

        public int AddInputField(
            string text,
            string subText = null,
            Color? textColor = null,
            Color? subTextColor = null,
            ...
            Action<string> valueChanged = null)
        {
            ...
            return AddInputField(inputFieldCellModel);
        }

        public int AddInputField(InputFieldCellModel model) { return AddItem(AssetKeys.INPUT_FIELD_CELL, model); }
            ...
            Action<float> valueChanged = null)
        {
            ...
            return AddSlider(sliderCellModel);
        }

        public int AddSlider(SliderCellModel model) { return AddItem(AssetKeys.SLIDER_CELL, model); }
        ...
        public int AddPicker(
            ...
            Sprite icon = null,
            Color? iconColor = null,
            Action<int> activeOptionChanged = null,
            Action clicked = null,
            Action confirmed = null)
        {
            ...
            return AddPicker(pickerCellModel);
        }

        public int AddPicker(PickerCellModel model) { return AddItem(AssetKeys.PICKER_CELL, model); }
        ...
        public int AddEnumPicker(
            ...
            Sprite icon = null,
            Color? iconColor = null,
            Action<Enum> activeValueChanged = null,
            Action clicked = null,
            Action confirmed = null)
        {
            ...
            return AddEnumPicker(pickerCellModel);
        }

        public int AddEnumPicker(EnumPickerCellModel model) { return AddItem(AssetKeys.ENUM_PICKER_CELL, model); }

        public int AddMultiPicker(
            IEnumerable<string> options,
            IEnumerable<int> activeOptionIndices,
            string text,
            Color? textColor = null,
            Color? subTextColor = null,
            Sprite icon = null,
            Color? iconColor = null,
            Action<int, bool> optionStateChanged = null,
            Action clicked = null,
            Action confirmed = null)
        {
            ...
            return AddMultiPicker(pickerCellModel);
        }

        public int AddMultiPicker(MultiPickerCellModel model) { return AddItem(AssetKeys.MULTI_PICKER_CELL, model); }
            ...
            Action confirmed = null)
        {
            ...
            return AddEnumMultiPicker(pickerCellModel);
        }

        public int AddEnumMultiPicker(EnumMultiPickerCellModel model) { return AddItem(AssetKeys.ENUM_MULTI_PICKER_CELL, model); }
            ...
            Action<bool> toggled = null)
        {
            ...
            return AddPickerOption(pickerOptionModel);
        }

        public int AddSearchField(string placeholder = null, Action<string> valueChanged = null, Action<string> submitted = null)
        {
            ...
            return AddSearchField(searchFieldCellModel);
        }

        public int AddSearchField(SearchFieldCellModel model) { return AddItem(AssetKeys.SEARCH_FIELD_CELL, model); }

        public int AddPickerOption(PickerOptionCellModel model) { return AddItem(AssetKeys.PICKER_OPTION, model); }
        ...
        public int AddPageLinkButton(
            ...
            string pageId = null)
        {
            return AddPageLinkButton<DebugPage>(text,
                subText,
                textColor,
                subTextColor,
                icon,
            ...
            string pageId = null)
        {
            ...
            return AddPageLinkButton(pageType,
                textModel,
                iconModel,
                titleOverride,
                onLoad,
            ...
            string pageId = null) where TPage : DebugPageBase
        {
            ...
            iconModel.Sprite = icon;
            if (iconColor != null) iconModel.Color = iconColor.Value;
            return AddPageLinkButton(textModel,
                iconModel,
                titleOverride,
                onLoad,
                pageId);
        ...
        public int AddPageLinkButton(
            ...
            int priority = 0)
        {
            return AddPageLinkButton<DebugPage>(textModel,
                iconModel,
                titleOverride,
                onLoad,
                pageId,
            ...
            string pageId = null) where TPage : DebugPageBase
        {
            ...
            iconModel.Sprite = icon;
            if (iconColor != null) iconModel.Color = iconColor.Value;
            return AddPageLinkButton(prefab,
                textModel,
                iconModel,
                titleOverride,
                onLoad,
            ...
            string pageId = null)
        {
            ...
            return AddPageLinkButton(buttonModel);
        }
        ...
        public int AddPageLinkButton(PageLinkButtonCellModel model) { return AddItem(AssetKeys.PAGE_LINK_BUTTON_CELL, model); }
    }
}