...
namespace Pancake.ExLib.Maths
{
    public class Triangulator
    {
        ...
        private LinkedList<Vertex> GenerateVertexList(Polygon polygon)
        {
            ...
            foreach (HoleData holeData in sortedHoleData)
            {
                ...
                validBridgeNodeOnHull.Value.isConvex = IsConvex(nodeBeforeStartBridgeNodeOnHull.Value.position,
                    validBridgeNodeOnHull.Value.position,
                    nodeAfterStartBridgeNodeOnHull.Value.position);
            }
        ...
        /// </summary>
        private bool IsConvex(Vector2 v0, Vector2 v1, Vector2 v2) { return Math2D.SideOfLine(v0, v2, v1) == -1; }
    }
}