...
namespace FullscreenEditor
{
    internal static class MenuItems
    {
        ...
        private static void Toolbar() { FullscreenPreferences.ToolbarVisible.Value = !FullscreenPreferences.ToolbarVisible; }

        [MenuItem(Shortcut.FULLSCREEN_ON_PLAY_PATH, false, 0)]
        private static void FullscreenOnPlay() { FullscreenPreferences.FullscreenOnPlayEnabled.Value = !FullscreenPreferences.FullscreenOnPlayEnabled; }
        ...
        private static bool MosaicValidate() { return FullscreenRects.ScreenCount >= 2; }
        ...
        private static void MosaicMenuItem()
        {
            ...
            var displays = DisplayInfo.GetDisplays().Where(d => (d.displayDevice.StateFlags & DisplayDeviceStateFlags.AttachedToDesktop) != 0).ToList();
