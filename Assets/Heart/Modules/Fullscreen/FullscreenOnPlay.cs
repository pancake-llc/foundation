...
namespace FullscreenEditor
{
    ...
    internal static class FullscreenOnPlay
    {
        ...
        {
            var fullscreens = Fullscreen.GetAllFullscreen().Select(fullscreen => fullscreen as FullscreenWindow).Where(fullscreen => fullscreen);
            ...
            if (FullscreenUtility.GetGameViews()
                .Any(gv =>
                {
                    if (!gv) return false;
        ...
        internal static EditorWindow FullscreenOnPlayGameView()
        {
            ...
            return FullscreenUtility.GetGameViews().FirstOrDefault(gv => gv);
        }
        ...
        internal static bool PlaymodeBehaviourImplemented(EditorWindow playmodeView) { return playmodeView.HasProperty("enterPlayModeBehavior"); }
