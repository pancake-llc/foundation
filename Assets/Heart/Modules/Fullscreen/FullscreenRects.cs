...
namespace FullscreenEditor
{
    ...
    public static class FullscreenRects
    {
        ...
        public static Rect GetMainDisplayRect()
        {
            ...
            {
                var mainDisplay = DisplayInfo.GetDisplays().FirstOrDefault(d => d.PrimaryDisplay);
        ...
        public static Rect GetCustomUserRect() { return FullscreenPreferences.CustomRect; }
        ...
        public static Rect GetDisplayBoundsAtPoint(Vector2 point) { return InternalEditorUtility.GetBoundsOfDesktopAtPoint(point); }
        ...
        public static Rect GetVirtualScreenBounds()
        {
            ...
            var rect = new Rect
            {
                yMin = y, xMin = x, width = width, height = height,
            };
