...
namespace FullscreenEditor
{
    ...
    public class DisplayInfo
    {
        ...
        public float ScreenHeight { get { return MonitorArea.yMax - MonitorArea.yMin; } }
        public float ScreenWidth { get { return MonitorArea.xMax - MonitorArea.xMin; } }
        ...
        public string DeviceName { get { return displayDevice.DeviceName; } }

        public string FriendlyName { get { return displayDevice.DeviceString; } }
        ...
        public Rect DpiCorrectedArea
        {
            get
            {
                ...
                return new Rect(Mathf.Round(origin.x / firstDisplayInfo.scaleFactor2),
        ...
        public Rect PhysicalArea { get { return new Rect(devMode.dmPositionX, devMode.dmPositionY, devMode.dmPelsWidth, devMode.dmPelsHeight); } }

        public float scaleFactor { get { return devMode.dmPelsWidth / (MonitorArea.xMax - MonitorArea.xMin); } }
        ...
        public static List<DisplayInfo> GetDisplays()
        {
            ...
            try
            {
                User32.EnumDisplayMonitors(IntPtr.Zero,
                    IntPtr.Zero,
