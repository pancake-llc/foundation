...
namespace FullscreenEditor
{
    public class FullscreenWindow : FullscreenContainer
    {
        ...
        private void SwapWindows(EditorWindow a, EditorWindow b)
        {
            ...
            Logger.Debug("Swapping windows {0} and {1} @ {2} and {3}",
                a,
                b,
                parentA,
                parentB);
        ...
        protected override void AfterOpening()
        {
            ...
            After.Milliseconds(50d,
                () =>
                {
                    ...
                    {
                        menuItemPath = Fullscreen.GetAllFullscreen()
        ...
        internal void OpenWindow<T>(Rect rect, T window = null) where T : EditorWindow { OpenWindow(rect, typeof(T), window); }
