...
namespace FullscreenEditor
{
    ...
    {
        public static void DoGUI(this PrefItem<int> pref) { pref.Value = EditorGUILayout.IntField(pref.Content, pref.Value); }

        public static void DoGUI(this PrefItem<float> pref) { pref.Value = EditorGUILayout.FloatField(pref.Content, pref.Value); }

        public static void DoGUI(this PrefItem<int> pref, int min, int max) { pref.Value = EditorGUILayout.IntSlider(pref.Content, pref.Value, min, max); }

        public static void DoGUI(this PrefItem<float> pref, float min, float max) { pref.Value = EditorGUILayout.Slider(pref.Content, pref.Value, min, max); }

        public static void DoGUI(this PrefItem<bool> pref) { pref.Value = EditorGUILayout.Toggle(pref.Content, pref.Value); }

        public static void DoGUI(this PrefItem<string> pref) { pref.Value = EditorGUILayout.TextField(pref.Content, pref.Value); }

        public static void DoGUI(this PrefItem<Color> pref) { pref.Value = EditorGUILayout.ColorField(pref.Content, pref.Value); }

        public static void DoGUI(this PrefItem<Rect> pref) { pref.Value = EditorGUILayout.RectField(pref.Content, pref.Value); }

        public static void DoGUI(this PrefItem<RectSourceMode> pref) { pref.Value = (RectSourceMode) EditorGUILayout.EnumPopup(pref.Content, pref.Value); }
    }
}