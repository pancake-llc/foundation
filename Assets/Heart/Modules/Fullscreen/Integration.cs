...
namespace FullscreenEditor
{
    ...
    public static class Integration
    {
        ...
        public static void SetDirectiveDefined(string directive, bool enabled)
        {
            ...
            if (enabled)
                SetAllDefines(GetAllDefines().Concat(new[] {directive}).ToArray());
            else
                SetAllDefines(GetAllDefines().Where(d => d != directive).ToArray());
        ...
        public static bool IsDirectiveDefined(string directive) { return GetAllDefines().Any(d => d == directive); }
    }
}