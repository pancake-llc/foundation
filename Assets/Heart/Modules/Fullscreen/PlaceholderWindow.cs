...
namespace FullscreenEditor
{
    ...
    public class PlaceholderWindow : EditorWindow
    {
        ...
        private bool PreviewSupported
        {
            get
            {
                return FullscreenContainer && !FullscreenContainer.Rect.Overlaps(position) && FullscreenContainer.m_dst.View && FullscreenContainer.m_src.Window &&
        ...
        private void OnDisable() { RenderTexture.ReleaseTemporary(m_previewRT); }
