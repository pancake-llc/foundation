...
namespace FullscreenEditor
{
    public struct GUIBackgroundColor : IDisposable
    {
        ...
        public void Dispose() { GUI.backgroundColor = before; }
    }
    ...
    public struct GUIContentColor : IDisposable
    {
        ...
        public void Dispose() { GUI.contentColor = before; }
    }
    ...
    public struct GUIColor : IDisposable
    {
        ...
        public void Dispose() { GUI.color = before; }
    }

    public sealed class GUIIndent : IDisposable
    {
        public GUIIndent() { EditorGUI.indentLevel++; }
    ...
    public struct GUIEnabled : IDisposable
    {
        ...
        public void Dispose() { GUI.enabled = before; }
    }
