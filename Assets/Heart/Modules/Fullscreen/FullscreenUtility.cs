...
namespace FullscreenEditor
{
    ...
    internal class SuppressLog : IDisposable
    {
        ...
        public void Dispose() { Logger.logEnabled = lastState; }
    }
    ...
    public static class FullscreenUtility
    {
        ...
        public class Icon
        {
            ...
            public Texture2D Texture { get { return m_texture ? m_texture : (m_texture = FindOrLoadTexture(m_base64)); } }

            public Icon(string base64) { m_base64 = base64; }

            public Icon(string base64, string proVariantBase64) { m_base64 = EditorGUIUtility.isProSkin ? proVariantBase64 : base64; }

            public static implicit operator Texture2D(Icon icon) { return icon.Texture; }
        }
        ...
        private static void RecalculateMousePosition() { mousePosition = GUIUtility.GUIToScreenPoint(Event.current.mousePosition); }
        ...
        public static T GetRef<T>(string name) where T : UnityObject { return Resources.FindObjectsOfTypeAll<T>().FirstOrDefault(obj => obj.name == name); }

        /// <summary>Find an object by it's name and type.</summary>
        /// <param name="name">The name of the object to search for.</param>
        /// <param name="type">The type of the object to search for.</param> 
        public static UnityObject GetRef(Type type, string name) { return Resources.FindObjectsOfTypeAll(type).FirstOrDefault(obj => obj.name == name); }
        ...
        public static EditorWindow[] GetGameViews() { return Resources.FindObjectsOfTypeAll(Types.GameView).Cast<EditorWindow>().ToArray(); }
        ...
        public static ScriptableObject[] GetAllViewChildren(ScriptableObject view)
        {
            ...
            return view.GetPropertyValue<Array>("allChildren").Cast<ScriptableObject>().ToArray();
        }
        ...
        public static float GetDisplayScaling() { return EditorGUIUtility.pixelsPerPoint; }
