...
namespace FullscreenEditor
{
    public class DisableSceneView
    {
        ...
        private static void Init()
        {
            ...
            patcher = new Patcher(typeof(SceneView).FindMethod(sceneGUIName), // Original method
            ...
            FullscreenPreferences.DisableSceneViewRendering.OnValueSaved += (v) => RenderingDisabled = v && Fullscreen.GetAllFullscreen().Length > 0;

            // On fullscreen open
            FullscreenCallbacks.afterFullscreenOpen += (f) => RenderingDisabled = true;
        ...
        public static void EnableRenderingTemporarily() { RenderingDisabled = false; }

        public static void EnableRenderingPermanently() { FullscreenPreferences.DisableSceneViewRendering.Value = false; }
    }
}