...
namespace PancakeEditor.Localization
{
    public static class EditorMenu
    {
        ...
        private static void ImportCsv() { LocaleEditorUtil.Import(); }

        [MenuItem("Tools/Pancake/Localization/Export CSV", priority = 10001)]
        private static void ExportCsv() { LocaleEditorUtil.Export(); }
        ...
        private static void ChangeToAfrikaans() { SetLanguage(Language.Afrikaans); }

        [MenuItem(MENU_NAME + "/Arabic", priority = 10003)]
        private static void ChangeToArabic() { SetLanguage(Language.Arabic); }

        [MenuItem(MENU_NAME + "/Basque", priority = 10003)]
        private static void ChangeToBasque() { SetLanguage(Language.Basque); }

        [MenuItem(MENU_NAME + "/Belarusian", priority = 10004)]
        private static void ChangeToBelarusian() { SetLanguage(Language.Belarusian); }

        [MenuItem(MENU_NAME + "/Bulgarian", priority = 10005)]
        private static void ChangeToBulgarian() { SetLanguage(Language.Bulgarian); }
        ...
        private static void ChangeToCzech() { SetLanguage(Language.Czech); }

        [MenuItem(MENU_NAME + "/Danish", priority = 10009)]
        private static void ChangeToDanish() { SetLanguage(Language.Danish); }

        [MenuItem(MENU_NAME + "/Dutch", priority = 10010)]
        private static void ChangeToDutch() { SetLanguage(Language.Dutch); }
        ...
        private static void ChangeToEstonian() { SetLanguage(Language.Estonian); }

        [MenuItem(MENU_NAME + "/Faroese", priority = 10013)]
        private static void ChangeToFaroese() { SetLanguage(Language.Faroese); }

        [MenuItem(MENU_NAME + "/Finnish", priority = 10014)]
        private static void ChangeToFinnish() { SetLanguage(Language.Finnish); }
        ...
        private static void ChangeToGreek() { SetLanguage(Language.Greek); }

        [MenuItem(MENU_NAME + "/Hebrew", priority = 10018)]
        private static void ChangeToHebrew() { SetLanguage(Language.Hebrew); }

        [MenuItem(MENU_NAME + "/Hungarian", priority = 10019)]
        private static void ChangeToHungarian() { SetLanguage(Language.Hungarian); }

        [MenuItem(MENU_NAME + "/Icelandic", priority = 10020)]
        private static void ChangeToIcelandic() { SetLanguage(Language.Icelandic); }

        [MenuItem(MENU_NAME + "/Indonesian", priority = 10021)]
        private static void ChangeToIndonesian() { SetLanguage(Language.Indonesian); }
        ...
        private static void ChangeToLatvian() { SetLanguage(Language.Latvian); }

        [MenuItem(MENU_NAME + "/Lithuanian", priority = 10026)]
        private static void ChangeToLithuanian() { SetLanguage(Language.Lithuanian); }

        [MenuItem(MENU_NAME + "/Norwegian", priority = 10027)]
        private static void ChangeToNorwegian() { SetLanguage(Language.Norwegian); }

        [MenuItem(MENU_NAME + "/Polish", priority = 10028)]
        private static void ChangeToPolish() { SetLanguage(Language.Polish); }
        ...
        private static void ChangeToRomanian() { SetLanguage(Language.Romanian); }
        ...
        private static void ChangeToSerboCroatian() { SetLanguage(Language.SerboCroatian); }

        [MenuItem(MENU_NAME + "/Slovak", priority = 10033)]
        private static void ChangeToSlovak() { SetLanguage(Language.Slovak); }

        [MenuItem(MENU_NAME + "/Slovenian", priority = 10034)]
        private static void ChangeToSlovenian() { SetLanguage(Language.Slovenian); }
        ...
        private static void ChangeToSwedish() { SetLanguage(Language.Swedish); }

        [MenuItem(MENU_NAME + "/Thai", priority = 10037)]
        private static void ChangeToThai() { SetLanguage(Language.Thai); }

        [MenuItem(MENU_NAME + "/Turkish", priority = 10038)]
        private static void ChangeToTurkish() { SetLanguage(Language.Turkish); }

        [MenuItem(MENU_NAME + "/Ukrainian", priority = 10039)]
        private static void ChangeToUkrainian() { SetLanguage(Language.Ukrainian); }
