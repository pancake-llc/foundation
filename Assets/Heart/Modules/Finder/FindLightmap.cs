...
{
    internal static class FindLightmap
    {
        ...
        private sealed class EnlightenSceneMapping
        {
            ...
            public EnlightenRendererInformation[] renderers { get => m_Renderers; set => m_Renderers = value; }

            public EnlightenSystemInformation[] systems { get => m_Systems; set => m_Systems = value; }

            public Hash128[] probesets { get => m_Probesets; set => m_Probesets = value; }

            public EnlightenSystemAtlasInformation[] systemAtlases { get => m_SystemAtlases; set => m_SystemAtlases = value; }

            public EnlightenTerrainChunksInformation[] terrainChunks { get => m_TerrainChunks; set => m_TerrainChunks = value; }
        }
        ...
        private struct SceneObjectIdentifier : IEquatable<SceneObjectIdentifier>
        {
            ...
            public bool Equals(SceneObjectIdentifier other) { return targetObject == other.targetObject && targetPrefab == other.targetPrefab; }
        ...
        private struct LightmapData
        {
            ...
            public Texture2D lightmap { get => m_Lightmap; set => m_Lightmap = value; }

            public Texture2D dirLightmap { get => m_DirLightmap; set => m_DirLightmap = value; }

            public Texture2D shadowMask { get => m_ShadowMask; set => m_ShadowMask = value; }
        }
    }
}