...
namespace Pancake.UI
{
    public sealed class AnonymousPageContainerCallbackReceiver : IPageContainerCallbackReceiver
    {
        ...
        void IPageContainerCallbackReceiver.BeforePush(Page enterPage, Page exitPage) { OnBeforePush?.Invoke((enterPage, exitPage)); }

        void IPageContainerCallbackReceiver.AfterPush(Page enterPage, Page exitPage) { OnAfterPush?.Invoke((enterPage, exitPage)); }
