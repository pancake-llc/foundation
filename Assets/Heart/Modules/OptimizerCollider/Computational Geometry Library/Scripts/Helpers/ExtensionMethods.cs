...
namespace Pancake.ComputationalGeometry
{
    public static class ExtensionMethods
    {
        ...
        public static Vector3 XYZ(this Vector2 v, float yPos = 0f) { return new Vector3(v.x, yPos, v.y); }


        //Convert between vectors: myvector3 to vector3, etc

        //Vector3 - MyVector2
        public static MyVector2 ToMyVector2(this Vector3 v) { return new MyVector2(v.x, v.z); }

        //Vector2 - MyVector2
        public static MyVector2 ToMyVector2(this Vector2 v) { return new MyVector2(v.x, v.y); }

        //Vector3 -> MyVector3
        public static MyVector3 ToMyVector3(this Vector3 v) { return new MyVector3(v.x, v.y, v.z); }

        //MyVector3 -> Vector3
        public static Vector3 ToVector3(this MyVector3 v) { return new Vector3(v.x, v.y, v.z); }

        //MyVector2 -> Vector3
        public static Vector3 ToVector3(this MyVector2 v, float yPos = 0f) { return new Vector3(v.x, yPos, v.y); }

        //MyVector2 -> Vector2
        public static Vector2 ToVector2(this MyVector2 v) { return new Vector2(v.x, v.y); }

        //MyVector2 -> MyVector3 (2d x is 3d x, 2d y is 3d z)
        public static MyVector3 ToMyVector3_Yis3D(this MyVector2 v, float yPos = 0f) { return new MyVector3(v.x, yPos, v.y); }

        //MyVector3 -> MyVector2
        public static MyVector2 ToMyVector2(this MyVector3 v) { return new MyVector2(v.x, v.z); }
        ...
        public static Matrix4x4 Add(this Matrix4x4 a, Matrix4x4 b)
        {
            ...
            return new Matrix4x4(new Vector4(a[0, 0] + b[0, 0], a[1, 0] + b[1, 0], a[2, 0] + b[2, 0], a[3, 0] + b[3, 0]),
        ...
        public static Matrix4x4 Multiply(this Matrix4x4 a, float b)
        {
            ...
            return new Matrix4x4(new Vector4(a[0, 0] * b, a[1, 0] * b, a[2, 0] * b, a[3, 0] * b),
