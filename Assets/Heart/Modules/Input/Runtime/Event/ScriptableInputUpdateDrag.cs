...
namespace Pancake.MobileInput
{
    ...
    public class ScriptableInputUpdateDrag : ScriptableInput
    {
        ...
        /// </summary>
        public event Action<Vector3, Vector3, Vector3> OnRaised { add => _onRaised += value; remove => _onRaised -= value; }

        /// <summary>
        /// Raise the event
        /// </summary>
        internal void Raise(Vector3 startPosition, Vector3 currentPosition, Vector3 correctionOffset)
        {
            if (!Application.isPlaying) return;
            _onRaised?.Invoke(startPosition, currentPosition, correctionOffset);
        }
    }
}