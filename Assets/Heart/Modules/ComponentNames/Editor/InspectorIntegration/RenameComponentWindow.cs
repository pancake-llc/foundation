...
namespace Sisus.ComponentNames.EditorOnly
{
    internal class RenameComponentWindow : EditorWindow
    {
        ...
        [NonSerialized] private string oldName;
        ...
        public static void Open(Rect position, Component component)
        {
            ...
            string oldName = NameContainer.TryGet(component, out var nameContainer) && nameContainer.NameOverride is string nameOverride && nameOverride.Length > 0
                ? nameOverride
                : component.GetName();
