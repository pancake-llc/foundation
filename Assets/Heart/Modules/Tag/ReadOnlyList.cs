...
namespace Pancake.ExTag
{
    ...
    public class ReadOnlyList<T> : IEnumerable<T>
    {
        ...
        public T this[int index] => _referenceList[index];
        ...
        public ReadOnlyList(IList<T> list) { _referenceList = list; }
        ...
        public IEnumerator<T> GetEnumerator() { return _referenceList.GetEnumerator(); }
        ...
        public bool Contains(T item) { return _referenceList.Contains(item); }
        ...
        public int IndexOf(T item) { return _referenceList.IndexOf(item); }
        ...
        public void CopyTo(T[] array, int arrayIndex) { _referenceList.CopyTo(array, arrayIndex); }
    }
}