...
namespace Pancake.BakingSheet.Unity
{
    ...
    public class JsonSheetUnityObjectConverter : JsonConverter<UnityEngine.Object>
    {
        ...
        public JsonSheetUnityObjectConverter(List<UnityEngine.Object> references) { _references = references; }
        ...
        {
            var serialized = new JsonSerializedUnityReference {MetaType = SheetMetaType.UnityObject, Value = -1};
