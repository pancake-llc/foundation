...
namespace Pancake.BakingSheet.Unity
{
    ...
    {
        [JsonProperty(SheetMetaType.PropertyName)] public string MetaType { get; set; }

        [JsonProperty] public string RawValue { get; set; }
    ...
    public class JsonSheetSOAssetPathConverter : JsonConverter<IUnitySheetAssetPath>
    {
        public override IUnitySheetAssetPath ReadJson(
            JsonReader reader,
            Type objectType,
            IUnitySheetAssetPath existingValue,
        ...
        public override void WriteJson(JsonWriter writer, IUnitySheetAssetPath value, JsonSerializer serializer)
        {
            if (value == null)
            {
                writer.WriteNull();
            ...
            var serialized = new JsonSerializedAssetPath {MetaType = value.MetaType, RawValue = value.RawValue,};
