...
namespace Pancake.BakingSheet.Unity
{
    ...
    {
        [SerializeField] private string serializedRow;

        [SerializeField] private List<UnityEngine.Object> references;
        ...
        internal T GetRow<T>() where T : class, ISheetRow { return GetRow(typeof(T)) as T; }
        ...
        internal void SetRow<T>(T row) where T : ISheetRow { _row = row; }
        ...
        public void OnAfterDeserialize() { _row = null; }
