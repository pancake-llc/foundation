...
namespace Pancake.BakingSheet.Internal
{
    public class PropertyNodeObject : PropertyNode
    {
        ...
        {
            ValueConverter = resolver.GetValueConverter(PropertyInfo) ?? resolver.GetValueConverter(ValueType);
            ...
            foreach (PropertyInfo propertyInfo in Config.GetEligibleProperties(ValueType))
            {
                ...
                var child = PropertyNode.Create(this,
                    childPath,
