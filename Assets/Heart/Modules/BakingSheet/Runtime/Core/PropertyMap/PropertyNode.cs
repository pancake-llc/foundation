...
namespace Pancake.BakingSheet.Internal
{
    public abstract class PropertyNode
    {
        ...
        protected PropertyNode(PropertyNode parent, string fullPath, Type valueType, GetterDelegate getter, SetterDelegate setter, PropertyInfo propertyInfo)
        {
            Parent = parent;
            FullPath = fullPath;
            ValueType = valueType;
        ...
        public void SetValue(ISheetRow row, int vindex, IEnumerator<object> indexer, object value) { ModifyValue(row, vindex, indexer, _ => value); }
            ...
            int depth)
        {
            ...
            {
                return new PropertyNodeList(parent,
                    fullPath,
                    type,
                    getter,
                    setter,
            ...
            {
                return new PropertyNodeDictionary(parent,
                    fullPath,
                    type,
                    getter,
                    setter,
            ...
            return new PropertyNodeObject(parent,
                fullPath,
                type,
                getter,
                setter,
