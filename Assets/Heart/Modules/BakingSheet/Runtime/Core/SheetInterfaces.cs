...
namespace Pancake.BakingSheet
{
    ...
    public interface ISheet<in TKey, out TRow> : ISheet, IReadOnlyList<TRow> where TRow : ISheetRow
    {
    ...
    public interface ISheet<out TRow> : ISheet<string, TRow> where TRow : ISheetRow
    {
    }
