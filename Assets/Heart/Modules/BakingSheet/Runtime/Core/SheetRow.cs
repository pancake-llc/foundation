...
namespace Pancake.BakingSheet
{
    ...
    public abstract class SheetRowArray<TKey, TElem> : SheetRow<TKey>, ISheetRowArray<TElem> where TElem : SheetRowElem, new()
    {
        [Preserve]
        ...
        public struct Enumerator : IEnumerator<TElem>
        {
            ...
            public Enumerator(List<TElem>.Enumerator enumerator) { _enumerator = enumerator; }
    ...
    /// For other type of Id, use generic version.
    /// </summary>
    public abstract class SheetRowArray<TElem> : SheetRowArray<string, TElem> where TElem : SheetRowElem, new()
    {
    }
}