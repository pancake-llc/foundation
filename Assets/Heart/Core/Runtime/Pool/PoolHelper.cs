...
namespace Pancake
{
    public static class PoolHelper
    {
        ...
        public static GameObject Request(this GameObject prefab) { return Pool.GetPoolByPrefab(prefab).Reuse(); }

        public static GameObject Request(this GameObject prefab, Transform parent) { return Pool.GetPoolByPrefab(prefab).Reuse(parent); }
        ...
        public static GameObject Request(this GameObject prefab, Vector3 position, Quaternion rotation) { return Pool.GetPoolByPrefab(prefab).Reuse(position, rotation); }
