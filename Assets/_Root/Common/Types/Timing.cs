...
public static class MECExtensionMethods2
{
    ...
    {
        yield return Pancake.Core.Timing.WaitForSeconds(timeToDelay);
    ...
    {
        while (Pancake.Core.Timing.MainThread != System.Threading.Thread.CurrentThread ||
    ...
    {
        while (Pancake.Core.Timing.MainThread != System.Threading.Thread.CurrentThread || (gameObject1 && gameObject1.activeInHierarchy &&
    ...
    public static IEnumerator<float> CancelWith(this IEnumerator<float> coroutine, System.Func<bool> condition)
    {
        ...
        while (Pancake.Core.Timing.MainThread != System.Threading.Thread.CurrentThread || (condition() && coroutine.MoveNext()))
            yield return coroutine.Current;
    }
    ...
    {
        while (Pancake.Core.Timing.MainThread == System.Threading.Thread.CurrentThread && gameObject)
        {
            ...
            {
                yield return Pancake.Core.Timing.WaitForOneFrame;
            }
        }
    }
    ...
    {
        while (Pancake.Core.Timing.MainThread == System.Threading.Thread.CurrentThread && gameObject1 && gameObject2)
        {
    ...
    public static IEnumerator<float> PauseWith<T>(this IEnumerator<float> coroutine, T script) where T : MonoBehaviour
    {
        ...
        while (Pancake.Core.Timing.MainThread == System.Threading.Thread.CurrentThread && myGO && myGO.GetComponent<T>() != null)
        {
    ...
    /// <returns>The modified coroutine handle.</returns>
    public static IEnumerator<float> KillWith(this IEnumerator<float> coroutine, Pancake.Core.CoroutineHandle otherCoroutine)
    {
    ...
    {
        return Superimpose(coroutineA, coroutineB, Pancake.Core.Timing.Instance);
    }
    ...
    /// <returns>The modified coroutine handle.</returns>
    public static IEnumerator<float> Superimpose(this IEnumerator<float> coroutineA, IEnumerator<float> coroutineB, Pancake.Core.Timing instance)
    {
