...
namespace Pancake.Core
{
    ...
    public sealed class ReadOnlyArray<T> : IReadOnlyList<T>
    {
        ...
        public Enumerator GetEnumerator() => new(this._source);
        ...
        /// </summary>
        /// <returns>An enumerator that can be used to iterate through the collection.</returns>
        IEnumerator<T> IEnumerable<T>.GetEnumerator() => new RefEnumerator(this._source);
        ...
        public struct Enumerator : IEnumerator<T>
        {
            ...
            public T Current => this._source[this._index];
    ...
    internal static class ReadOnlyArrayExtensions
    {
        ...
        /// <param name="source"></param>
        /// <returns></returns>
        public static ReadOnlyArray<T> ToReadOnlyArray<T>(this IEnumerable<T> source) => source is T[] array ? new(array) : new(source.ToArray());
        ...
        /// <param name="source"></param>
        /// <returns></returns>
        public static ReadOnlyArray<T> AsReadOnly<T>(this T[] source) => new(source);
    }
}