...
namespace Pancake.Editor.Finder
{
    ...
    {
        [NonSerialized] public HashSet<string> referencers = new HashSet<string>();

        [NonSerialized] public HashSet<string> dependencies = new HashSet<string>();

        [SerializeField] public string[] _references;

        [SerializeField] public string[] _dependencies;
        ...
        public AssetInfo(string path) { this.path = path; }

        public string[] GetDependencies() { return AssetDatabase.GetDependencies(path, recursive: false); }

        public void ClearIncludedStatus() { includedStatus = IncludedInBuild.Unknown; }

        [NonSerialized] private IncludedInBuild includedStatus;
