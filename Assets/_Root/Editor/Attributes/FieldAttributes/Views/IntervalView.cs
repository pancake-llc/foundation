...
namespace Pancake.Editor
{
    ...
    sealed class IntervalView : FieldView, ITypeValidationCallback
    {
        ...
        public override void OnGUI(Rect position, SerializedField element, GUIContent label)
        {
            ...
            switch (element.serializedProperty.propertyType)
            {
                case SerializedPropertyType.Vector2:
                    OnVector2FloatGUI(position, element);
                    break;
                case SerializedPropertyType.Vector2Int:
                    OnVector2IntGUI(position, element);
                    break;
            }
        }

        private void OnVector2FloatGUI(Rect position, SerializedField element)
        {
        ...
        private void OnVector2IntGUI(Rect position, SerializedField element)
        {
            Vector2Int vector = element.serializedProperty.vector2IntValue;
            ...
            element.serializedProperty.vector2IntValue = vector;
        }
