...
namespace Pancake.Editor
{
    public abstract class ConditionManipulator : MemberManipulator
    {
        ...
        public override void Initialize(SerializedMember serializedMember, ManipulatorAttribute ManipulatorAttribute)
        {
            ...
            FindExpression(serializedMember, attribute, out expression);
        }
        ...
        protected virtual void FindExpression(SerializedMember serializedMember, ConditionAttribute attribute, out Func<bool> expression)
        {
            target = serializedMember.GetSerializedObject().targetObject;
