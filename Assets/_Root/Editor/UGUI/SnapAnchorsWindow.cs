...
namespace Pancake.UI.Editor
{
    public class SnapAnchorsWindow : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            switch (_mode)
            {
                case AnchorMode.Border:
                {
                    ...
                    if (GUILayout.Button(new GUIContent(Uniform.AllBorderPic, "Snap to all borders"), GUILayout.Width(120), GUILayout.Height(120)))
                        SnapBorder(left: true, right: true, top: true, bottom: true);


                    // TOP DOWN
                    if (GUILayout.Button(new GUIContent(Uniform.VerticalBorderPic, "Snap to top and bottom border"), GUILayout.Width(60), GUILayout.Height(120)))
                    ...
                    GUILayout.FlexibleSpace();
                    // LEFT RIGHT
                    if (GUILayout.Button(new GUIContent(Uniform.HorizontalBorderPic, "Snap to left and right border"), GUILayout.Width(120), GUILayout.Height(60)))
        ...
        private void DrawPointButtons()
        {
            ...
            if (GUILayout.Button(new GUIContent(Uniform.PointPic, "Snap all directions to position"), GUILayout.Width(120), GUILayout.Height(100)))
                SnapPoint(horizontal: true, vertical: true);

            // TOP DOWN
            if (GUILayout.Button(new GUIContent(Uniform.VerticalPointPic, "Snap vertically to position"), GUILayout.Width(60), GUILayout.Height(100)))
            ...
            // LEFT RIGHT
            if (GUILayout.Button(new GUIContent(Uniform.HorizontalPointPic, "Snap horizontally to position"), GUILayout.Width(120), GUILayout.Height(60)))
