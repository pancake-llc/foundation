namespace Pancake.Editor.SOA
{
    ...
    public static class BaseReferenceHelper
    {
        ...
        public static Type GetReferenceType(FieldInfo fieldInfo) { return fieldInfo.FieldType; }
        ...
        private static bool IsList(Type referenceType) { return typeof(IList).IsAssignableFrom(referenceType); }
    }
}