...
namespace Pancake.Editor.SOA
{
    public class SO_CodeGenerationWindow : EditorWindow
    {
        ...
        [MenuItem("Tools/Pancake/SO Code Generation")]
        ...
        private void OnGUI()
        {
            ...
            if (GUILayout.Button("Generate"))
            {
                ...
                SO_CodeGenerator.Generate(data, _overwrite);
        ...
        private void DataFields()
        {
            ...
            EditorGUILayout.HelpBox("Turn On to allow data to be overwritten if it already exists", MessageType.Info);
            _overwrite = EditorGUILayout.Toggle("Overwrite", _overwrite);
        }
        /// <summary>
