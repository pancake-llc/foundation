...
{
    public class ExSearchableWindow : ScriptableObject, ISearchWindowProvider, IExSearchWindow, IExSearchWindowEntry
    {
        ...
        public static ExSearchableWindow Create(string title)
        {
            ExSearchableWindow window = CreateInstance<ExSearchableWindow>();
        ...
        /// </summary>
        /// <returns>ExSearchWindow instance.</returns>
        public static ExSearchableWindow Create()
        {
