...
namespace Pancake.SaveData
	{
	public class ArrayType3D : CustomCollectionType
	{
		public ArrayType3D(Type type) : base(type){}
		...
		public override object Read(Reader reader)
		{
			...
			var array = Reflection.ArrayCreateInstance(elementType.type, new int[]{length1,length2,length3});
