Shader "Greenery/GreeneryInstance"
{
    Properties
    {
        ...
        _WindMasking("Wind masking", float) = 0
    }
    SubShader
    {
        Cull Off
        ...
        float4x4 inverse(float4x4 m)
        {
            ...
            StructuredBuffer<float4> _SurfaceColorBuffer;
        ...
        void vert(inout appdata_full v, out Input o) {
                ...
                v.vertex.xz += wind * _WindStrengthFactor * saturate(v.vertex.y - _WindMasking);
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            } else
            {
                ...
                float4 surfaceColor = _SurfaceColorBuffer[_VisibleInstanceIDBuffer[unity_InstanceID]];
                float blendingFactor = pow(saturate(IN.uv_MainTex.y - _SurfaceBlendingHeight), _SurfaceBlendingFalloff);
                o.Albedo = surfaceColor.a > 0 ? lerp(surfaceColor, c.rgb, blendingFactor) * color : c.rgb * color;
            #else
                o.Albedo = c.rgb;
            #endif
