...
namespace Pancake.Init
{
	...
	public static class InitArgs<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument>
	{
		...
		public static bool TryGet<TClient>(Context context, [JetBrains.Annotations.NotNull] TClient client) where TClient : IInitializable<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument>
		{
