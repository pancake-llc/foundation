...
namespace Pancake.Init
{
	...
	public abstract class WrapperInitializerBase<TWrapper, TWrapped, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument> : MonoBehaviour, IInitializer<TWrapped, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument>, IValueProvider<TWrapped>
		#if DEBUG
		...
		where TWrapper : Wrapper<TWrapped>
	{
		...
		public TWrapped InitTarget()
		{
			...
			if(target is IInitializable<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument> initializable && CreateWrappedObject() is var wrappedObject)
			{
