...
namespace Pancake.Init
{
	...
	public abstract class WrapperInitializerBase<TWrapper, TWrapped, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument, TSixthArgument> : MonoBehaviour, IInitializer, IValueProvider<TWrapped>
		#if DEBUG
		...
		where TWrapper : Wrapper<TWrapped>
	{
		...
		private TWrapped InitTarget()
		{
			...
			var wrappedObject = CreateWrappedObject(firstArgument, secondArgument, thirdArgument, fourthArgument, fifthArgument, sixthArgument);
