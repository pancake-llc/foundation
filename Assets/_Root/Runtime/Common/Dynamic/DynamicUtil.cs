...
namespace Pancake
{
    ...
    public static class DynamicUtil
    {
        ...
        public static IDynamicAccessorImp Accessor { get { return _accessor; } set { _accessor = value ?? StandardDynamicAccessorImp.Default; } }
        ...
        public static bool SetValue(this object obj, MemberInfo member, object value) { return _accessor.SetValue(obj, member, value); }

        public static bool SetValue(this object obj, MemberInfo member, object value, params object[] index) { return _accessor.SetValue(obj, member, value, index); }

        public static bool SetValue<T>(this object obj, MemberInfo member, T value) { return _accessor.SetValue<T>(obj, member, value); }
        ...
        public static bool SetValueDirect(object obj, string sprop, object value) { return SetValueDirect(obj, sprop, value, (object[]) null); }
        ...
        public static bool SetValueDirect(object obj, MemberInfo member, object value) { return SetValueDirect(obj, member, value, (object[]) null); }
        ...
        {
            const BindingFlags BINDING = BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.InvokeMethod |
            ...
            try
            {
                ...
                object state;
                var method = DynamicBinder.Default.BindToMethod(BINDING,
                    methods,
                    ref args,
                    null,
        ...
        public static IEnumerable<MemberInfo> GetMembersDirect(
            object obj,
            bool includeNonPublic,
            MemberTypes mask = MemberTypes.Field | MemberTypes.Property | MemberTypes.Method)
        {
            if (obj == null) return Enumerable.Empty<MemberInfo>();
        ...
        public static IEnumerable<string> GetMemberNamesDirect(
            object obj,
            bool includeNonPublic,
            MemberTypes mask = MemberTypes.Field | MemberTypes.Property | MemberTypes.Method)
        {
        ...
        public static IEnumerable<MemberInfo> GetMembersFromType(
            System.Type tp,
            bool includeNonPublic,
            MemberTypes mask = MemberTypes.Field | MemberTypes.Property | MemberTypes.Method)
        {
        ...
        public static IEnumerable<string> GetMemberNamesFromType(
            System.Type tp,
            bool includeNonPublic,
            MemberTypes mask = MemberTypes.Field | MemberTypes.Property | MemberTypes.Method)
        {
        ...
        public static MemberInfo GetMemberFromType(
            Type tp,
            string sMemberName,
            bool includeNonPublic,
            MemberTypes mask = MemberTypes.Field | MemberTypes.Property | MemberTypes.Method)
        ...
        private static bool IsValidValueSetterMember(MemberInfo member, System.Type valueType)
        {
            switch (member.MemberType)
            {
                case System.Reflection.MemberTypes.Field:
                    var field = member as System.Reflection.FieldInfo;
                    if ((valueType == null && !field.FieldType.IsValueType) || field.FieldType.IsAssignableFrom(valueType) ||
                ...
                case System.Reflection.MemberTypes.Method:
                {
                    ...
                    if ((valueType == null && !paramInfos[0].ParameterType.IsValueType) || paramInfos[0].ParameterType.IsAssignableFrom(valueType) ||
        ...
        private class DynamicBinder : Binder
        {
            ...
            {
                return Type.DefaultBinder.SelectProperty(bindingAttr,
                    match,
                    returnType,
                    indexes,
                    modifiers);
                ...
                out object state)
            {
                ...
                return Type.DefaultBinder.BindToMethod(bindingAttr,
                    match,
                    ref args,
                    modifiers,
                    culture,
            ...
            public override object ChangeType(object value, Type type, CultureInfo culture) { return Type.DefaultBinder.ChangeType(value, type, culture); }
