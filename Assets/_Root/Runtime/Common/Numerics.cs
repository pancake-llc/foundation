...
namespace Pancake
{
    ...
    public static class Numerics
    {
        ...
        public static byte[] GetBytes(float value)
        {
            ...
            if (BitConverter.IsLittleEndian) System.Array.Reverse((Array) result);
            return result;
        }
    ...
    /// </summary>
    [System.Serializable()]
    public struct DiscreteFloat : INumeric,
        IConvertible,
        IComparable,
        IComparable<float>,
        IComparable<DiscreteFloat>,
        IEquatable<float>,
        IEquatable<DiscreteFloat>,
        IFormattable
    {
        ...
        public DiscreteFloat(float f) { _value = Mathf.Round(f); }
        ...
        public static DiscreteFloat Zero { get { return new DiscreteFloat() {_value = 0f}; } }
        ...
        public static bool IsNaN(DiscreteFloat value) { return float.IsNaN(value._value); }

        public static bool IsInfinity(DiscreteFloat value) { return float.IsInfinity(value._value); }

        public static bool IsPositiveInfinity(DiscreteFloat value) { return float.IsPositiveInfinity(value._value); }

        public static bool IsNegativeInfinity(DiscreteFloat value) { return float.IsNegativeInfinity(value._value); }

        public static bool IsReal(DiscreteFloat value) { return !(float.IsNaN(value._value) || float.IsInfinity(value._value)); }
        ...
        public static DiscreteFloat operator +(DiscreteFloat df) { return df; }
        ...
        public static bool operator >(DiscreteFloat a, DiscreteFloat b) { return a._value > b._value; }
        ...
        public static implicit operator DiscreteFloat(int f) { return new DiscreteFloat((float) f); }

        public static explicit operator int(DiscreteFloat df) { return (int) df._value; }

        public static implicit operator DiscreteFloat(float f) { return new DiscreteFloat(f); }

        public static implicit operator float(DiscreteFloat df) { return df._value; }

        public static explicit operator DiscreteFloat(double d) { return new DiscreteFloat((float) d); }

        public static implicit operator double(DiscreteFloat df) { return (double) df._value; }

        public static explicit operator DiscreteFloat(decimal d) { return new DiscreteFloat((float) d); }

        public static explicit operator decimal(DiscreteFloat df) { return (decimal) df._value; }

        #endregion

        #region INumeric Interface

        TypeCode INumeric.GetUnderlyingTypeCode() { return TypeCode.Single; }

        public byte[] ToByteArray() { return Numerics.GetBytes(_value); }

        void INumeric.FromByteArray(byte[] data) { _value = Mathf.Round(Numerics.ToSingle(data)); }

        void INumeric.FromLong(long value) { _value = Convert.ToSingle(value); }

        void INumeric.FromDouble(double value) { _value = (float) Math.Round(value); }
        ...
        bool IConvertible.ToBoolean(IFormatProvider provider) { return _value != 0f; }
        ...
        DateTime IConvertible.ToDateTime(IFormatProvider provider) { return Convert.ToDateTime(_value); }

        string IConvertible.ToString(IFormatProvider provider) { return _value.ToString(provider); }

        object IConvertible.ToType(Type conversionType, IFormatProvider provider) { return (_value as IConvertible).ToType(conversionType, provider); }
        ...
        public int CompareTo(float other) { return _value.CompareTo(other); }

        public int CompareTo(DiscreteFloat other) { return _value.CompareTo(other._value); }

        #endregion

        #region IEquatable Interface

        public bool Equals(float other) { return _value.Equals(other); }

        public bool Equals(DiscreteFloat other) { return _value.Equals(other._value); }

        #endregion

        #region IFormattable Interface

        public string ToString(string format, IFormatProvider formatProvider) { return _value.ToString(format, formatProvider); }
