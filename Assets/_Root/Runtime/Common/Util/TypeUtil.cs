...
namespace Pancake
{
    public static class TypeUtil
    {
        ...
        static TypeUtil()
        {
            using (var lst = Pancake.TempCollection.GetList<Assembly>())
            {
        ...
        public static bool IsObsolete(this System.Reflection.MemberInfo member) { return Attribute.IsDefined(member, _obsoleteAttribType); }
    }
}