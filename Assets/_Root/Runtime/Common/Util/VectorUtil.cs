...
namespace Pancake
{
    ...
    public static class VectorUtil
    {
        ...
        public static bool IsNaN(Vector2 v) { return float.IsNaN(v.sqrMagnitude); }

        public static bool IsNaN(Vector3 v) { return float.IsNaN(v.sqrMagnitude); }

        public static bool IsNaN(Vector4 v) { return float.IsNaN(v.sqrMagnitude); }

        public static float SqrDistance(Vector2 a, Vector2 b) { return (a - b).sqrMagnitude; }

        public static float SqrDistance(Vector3 a, Vector3 b) { return (a - b).sqrMagnitude; }

        #region Vector Convert

        public static string Stringify(Vector2 v) { return v.x.ToString() + "," + v.y.ToString(); }

        public static string Stringify(Vector3 v) { return v.x.ToString() + "," + v.y.ToString() + "," + v.z.ToString(); }

        public static string Stringify(Vector4 v) { return v.x.ToString() + "," + v.y.ToString() + "," + v.z.ToString() + "," + v.w.ToString(); }
        ...
        /// <param name="v"></param>
        /// <returns></returns>
        public static float Angle(Vector2 v) { return Mathf.Atan2(v.y, v.x) * MathUtil.RAD_TO_DEG; }
        ...
        /// <param name="y"></param>
        /// <returns></returns>
        public static float Angle(float x, float y) { return Mathf.Atan2(y, x) * MathUtil.RAD_TO_DEG; }
        ...
        public static Vector2 Normalize(this Vector2 v) { return v.normalized; }
        ...
        public static Vector2 Average(Vector2 a, Vector2 b) { return (a + b) / 2f; }

        public static Vector2 Average(Vector2 a, Vector2 b, Vector2 c) { return (a + b + c) / 3f; }

        public static Vector2 Average(Vector2 a, Vector2 b, Vector2 c, Vector2 d) { return (a + b + c + d) / 4f; }
        ...
        public static Vector3 Average(Vector3 a, Vector3 b) { return (a + b) / 2f; }

        public static Vector3 Average(Vector3 a, Vector3 b, Vector3 c) { return (a + b + c) / 3f; }

        public static Vector3 Average(Vector3 a, Vector3 b, Vector3 c, Vector3 d) { return (a + b + c + d) / 4f; }
        ...
        public static float GetMaxScalar(Vector2 v) { return Mathf.Max(v.x, v.y); }

        public static float GetMaxScalar(Vector3 v) { return Mathf.Max(v.x, v.y, v.z); }

        public static float GetMaxScalar(Vector4 v) { return Mathf.Max(v.x, v.y, v.z, v.z); }

        public static float GetMinScalar(Vector2 v) { return Mathf.Min(v.x, v.y); }

        public static float GetMinScalar(Vector3 v) { return Mathf.Min(v.x, v.y, v.z); }

        public static float GetMinScalar(Vector4 v) { return Mathf.Min(v.x, v.y, v.z, v.z); }
        ...
        public static bool NearZeroVector(this Vector4 v) { return MathUtil.FuzzyEqual(v.sqrMagnitude, 0f, MathUtil.EPSILON_SQR); }

        public static bool NearZeroVector(this Vector3 v) { return MathUtil.FuzzyEqual(v.sqrMagnitude, 0f, MathUtil.EPSILON_SQR); }

        public static bool NearZeroVector(this Vector2 v) { return MathUtil.FuzzyEqual(v.sqrMagnitude, 0f, MathUtil.EPSILON_SQR); }

        public static bool FuzzyEquals(this Vector2 a, Vector2 b) { return MathUtil.FuzzyEqual(Vector3.SqrMagnitude(a - b), 0f, MathUtil.EPSILON_SQR); }

        public static bool FuzzyEquals(this Vector2 a, Vector2 b, float epsilon) { return MathUtil.FuzzyEqual(Vector3.SqrMagnitude(a - b), 0f, epsilon); }

        public static bool FuzzyEquals(this Vector3 a, Vector3 b) { return MathUtil.FuzzyEqual(Vector3.SqrMagnitude(a - b), 0f, MathUtil.EPSILON_SQR); }

        public static bool FuzzyEquals(this Vector3 a, Vector3 b, float epsilon) { return MathUtil.FuzzyEqual(Vector3.SqrMagnitude(a - b), 0f, epsilon); }

        public static bool FuzzyEquals(this Vector4 a, Vector4 b) { return MathUtil.FuzzyEqual(Vector4.SqrMagnitude(a - b), 0f, MathUtil.EPSILON_SQR); }

        public static bool FuzzyEquals(this Vector4 a, Vector4 b, float epsilon) { return MathUtil.FuzzyEqual(Vector4.SqrMagnitude(a - b), 0f, epsilon); }
        ...
        /// <param name="t"></param>
        /// <returns></returns>
        public static Vector2 Lerp(Vector2 a, Vector2 b, float t) { return (b - a) * t + a; }
        ...
        /// <param name="t"></param>
        /// <returns></returns>
        public static Vector3 Lerp(Vector3 a, Vector3 b, float t) { return (b - a) * t + a; }
        ...
        /// <param name="t"></param>
        /// <returns></returns>
        public static Vector4 Lerp(Vector4 a, Vector4 b, float t) { return (b - a) * t + a; }
        ...
        public static string ToDetailedString(this Vector2 v) { return System.String.Format("<{0}, {1}>", v.x, v.y); }
        public static string ToDetailedString(this Vector3 v) { return System.String.Format("<{0}, {1}, {2}>", v.x, v.y, v.z); }
