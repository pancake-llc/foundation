    ...
    public class CwInputManager : MonoBehaviour
    {
        ...
        public class Finger
        {
            ...
            public Vector2 GetSmoothScreenPosition(float t)
            {
                if (Up == false)
                {
                    return Hermite(ScreenPositionOldOldOld,
        ...
        public static List<Finger> Fingers { get { return fingers; } }
        ...
        public static bool PointOverGui(Vector2 screenPosition, int guiLayers = 1 << 5) { return RaycastGui(screenPosition, guiLayers).Count > 0; }
