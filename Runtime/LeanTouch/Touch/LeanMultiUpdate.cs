...
namespace Lean.Touch
{
    ...
    public class LeanMultiUpdate : MonoBehaviour
    {
        ...
        public LeanFingerListEvent OnFingers
        {
            get
            {
                if (onFingers == null) onFingers = new LeanFingerListEvent();
                return onFingers;
            }
        }
        ...
        [System.NonSerialized] private bool constrained;

        [System.NonSerialized] private Vector2 cumilativeDelta;
        ...
        protected virtual void OnEnable() { LeanTouch.OnFingerDown += HandleFingerDown; }
        ...
        protected virtual List<LeanFinger> GetFingers() { return Use.UpdateAndGetFingers(false); }
...
namespace Lean.Touch.Editor
{
    ...
    {
        protected virtual void DrawIgnore() { Draw("ignoreIfStatic", "If the finger didn't move, ignore it?"); }
