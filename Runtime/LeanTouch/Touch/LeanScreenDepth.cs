...
namespace Lean.Touch
{
    ...
    public struct LeanScreenDepth
    {
        ...
        {
            var camera = Pancake.C.GetCamera(Camera, gameObject);
        ...
        private bool Exists<T>(GameObject gameObject, ref T instance) where T : Object
        {
...
namespace Lean.Touch.Editor
{
    ...
    public class LeanScreenDepth_Drawer : PropertyDrawer
    {
                ...
                switch (conversion)
                {
                    case LeanScreenDepth.ConversionType.FixedDistance:
                    {
                        ...
                        DrawProperty(ref rect,
                            ...
                            "Distance",
                            "Distance",
                            "The world space distance from the camera the point will be placed. This should be greater than 0.");
                        CwEditor.EndError();
                    }
                        break;
                    ...
                    case LeanScreenDepth.ConversionType.DepthIntercept:
                    {
                        DrawProperty(ref rect,
                            ...
                            "Distance",
                            "Z =",
                            "The world space point along the Z axis the plane will be placed. For normal 2D scenes this should be 0.");
                    }
                        break;
                    ...
                    case LeanScreenDepth.ConversionType.PhysicsRaycast:
                    {
                        ...
                        DrawProperty(ref rect,
                            ...
                            "Distance",
                            "Offset",
                            "The world space offset from the raycast hit point.");
                    }
                        break;
                    ...
                    case LeanScreenDepth.ConversionType.PlaneIntercept:
                    {
                        ...
                        DrawProperty(ref rect,
                            ...
                            "Distance",
                            "Offset",
                            "The world space offset from the intercept hit point.");
                    }
                        break;
                    ...
                    case LeanScreenDepth.ConversionType.PathClosest:
                    {
                        ...
                        DrawProperty(ref rect,
                            ...
                            "Distance",
                            "Max Delta",
                            "The maximum amount of segments that can be moved between.");
                    }
                        break;
                    ...
                    case LeanScreenDepth.ConversionType.AutoDistance:
                    {
                        DrawProperty(ref rect,
                            ...
                            "Distance",
                            "Offset",
                            "The depth offset from the calculated point.");
                    }
                        break;
                    ...
                    case LeanScreenDepth.ConversionType.HeightIntercept:
                    {
                        DrawProperty(ref rect,
                            ...
                            "Distance",
                            "Y =",
                            "The world space point along the Y axis the plane will be placed. For normal top down scenes this should be 0.");
                    }
                        break;
                }
            }
        ...
        private void DrawObjectProperty<T>(ref Rect rect, SerializedProperty property, string title, string tooltip) where T : Object
        {
            ...
            var newValue = EditorGUI.ObjectField(rect,
