...
namespace Lean.Touch
{
    ...
    public partial class LeanTouch : MonoBehaviour
    {
        ...
        public static float CurrentTapThreshold { get { return Instances.Count > 0 ? Instances[0].tapThreshold : DEFAULT_TAP_THRESHOLD; } }
        ...
        public static float CurrentSwipeThreshold { get { return Instances.Count > 0 ? Instances[0].swipeThreshold : DEFAULT_SWIPE_THRESHOLD; } }
		...
		public float ReclaimThreshold { set { reclaimThreshold = value; } get { return reclaimThreshold; } } [SerializeField] private float reclaimThreshold =
 DEFAULT_RECLAIM_THRESHOLD;
        ...
        public static int CurrentReferenceDpi { get { return Instances.Count > 0 ? Instances[0].referenceDpi : DEFAULT_REFERENCE_DPI; } }
        ...
        public static LayerMask CurrentGuiLayers { get { return Instances.Count > 0 ? Instances[0].guiLayers : (LayerMask) DEFAULT_GUI_LAYERS; } }
        ...
        public bool DisableMouseEmulation
        {
            set
            {
                disableMouseEmulation = value;
                UpdateMouseEmulation();
            }
            get { return disableMouseEmulation; }
        }
        ...
        public static LeanTouch Instance { get { return Instances.Count > 0 ? Instances[0] : null; } }
        ...
        public static bool PointOverGui(Vector2 screenPosition) { return RaycastGui(screenPosition).Count > 0; }
        ...
        public static List<RaycastResult> RaycastGui(Vector2 screenPosition) { return RaycastGui(screenPosition, CurrentGuiLayers); }
...
namespace Lean.Touch.Editor
{
    ...
    public class LeanTouch_Editor : CwEditor
    {
        ...
        private void DrawSettings(LeanTouch touch)
        {
...
#endif
            Draw("referenceDpi",
                "This allows you to set the default DPI you want the input scaling to be based on. For example, if you set this to 200 and your display has a DPI of 400, then the <b>ScaledDelta</b> finger value will be half the distance of the pixel space <b>ScreenDelta</b> value.");
            ...
            Draw("disableMouseEmulation",
                ref updateMouseEmulation,
        ...
        private void DrawFingers(LeanTouch touch)
        {
            ...
            for (var i = 0; i < allFingers.Count; i++)
            {
                ...
                if (style.normal.textColor.a > 0.0f)
                {
                    ...
                    EditorGUILayout.LabelField(finger.Index + " - " + state + " - " + finger.TapCount + "  + " + Mathf.FloorToInt(screenPosition.x) + ", " +
                                               Mathf.FloorToInt(screenPosition.y) + ") - " + finger.Age.ToString("0.0"),
                        style);
                }
            }
        }
