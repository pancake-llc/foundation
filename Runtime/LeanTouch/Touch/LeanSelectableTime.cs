...
namespace Lean.Touch
{
    ...
    public class LeanSelectableTime : LeanSelectableBehaviour
    {
        ...
        public SendType Send { set { send = value; } get { return send; } }

        [SerializeField] private SendType send;

        /// <summary>Based on the <b>Send</b> setting, this event will be invoked.
        /// Float = Seconds selected.</summary>
        public FloatEvent OnSeconds
        {
            get
            {
                if (onSeconds == null) onSeconds = new FloatEvent();
                return onSeconds;
            }
        }

        [SerializeField] private FloatEvent onSeconds;
