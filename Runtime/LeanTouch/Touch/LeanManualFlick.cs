...
namespace Lean.Touch
{
    ...
    public class LeanManualFlick : LeanSwipeBase
    {
        ...
        public CheckType Check { set { check = value; } get { return check; } }

        [SerializeField] private CheckType check;

        // Additional finger data
        [SerializeField] private List<FingerData> fingerDatas;
        ...
        public void RemoveFinger(LeanFinger finger) { LeanFingerData.Remove(fingerDatas, finger); }
        ...
        protected virtual void OnEnable() { LeanTouch.OnFingerUp += HandleFingerUp; }

        protected virtual void OnDisable() { LeanTouch.OnFingerUp -= HandleFingerUp; }
