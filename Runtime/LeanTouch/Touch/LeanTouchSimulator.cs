...
namespace Lean.Touch
{
    ...
    public class LeanTouchSimulator : MonoBehaviour
    {
        ...
        [System.NonSerialized] private LeanTouch cachedTouch;
        ...
        protected virtual void OnDisable() { cachedTouch.OnSimulateFingers -= HandleSimulateFingers; }
...
namespace Lean.Touch.Editor
{
    ...
    public class LeanTouchSimulator_Editor : CwEditor
    {
        ...
        static void Hook() { LeanTouch_Editor.OnExtendInspector += HandleExtendInspector; }
