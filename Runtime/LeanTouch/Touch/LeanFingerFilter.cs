...
namespace Lean.Touch
{
    ...
    public class LeanFingerFilter
    {
        ...
        [System.NonSerialized] private List<LeanFinger> filteredFingers;

        public LeanFingerFilter(bool newIgnoreStartedOverGui)
            : this(default(FilterType),
                newIgnoreStartedOverGui,
                default(int),
                default(int),
                default(LeanSelectable))
        {
        }

        public LeanFingerFilter(
            FilterType newFilter,
            bool newIgnoreStartedOverGui,
            int newRequiredFingerCount,
            int newRequiredMouseButtons,
            LeanSelectable newRequiredSelectable)
        {
            Filter = newFilter;
