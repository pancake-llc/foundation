...
namespace Lean.Touch
{
    ...
    public class LeanMultiTwist : MonoBehaviour
    {
        ...
        public OneFingerType OneFinger { set { oneFinger = value; } get { return oneFinger; } }

        [SerializeField] private OneFingerType oneFinger;

        public FloatEvent OnTwistDegrees
        {
            get
            {
                if (onTwistDegrees == null) onTwistDegrees = new FloatEvent();
                return onTwistDegrees;
            }
        }

        [SerializeField] private FloatEvent onTwistDegrees;
        ...
        protected virtual void Update()
        {
            ...
            if (fingers.Count > 0)
            {
                ...
                else if (oneFinger != OneFingerType.None)
                {
                    ...
                    var referencePoint = oneFinger == OneFingerType.FingerStart
                        ? firstFinger.StartScreenPosition
