...
namespace Lean.Touch
{
    ...
    public class LeanSelectableDial : LeanSelectableByFingerBehaviour
    {
        ...
        {
            [Tooltip("The central Angle of this trigger in degrees.")] public float Angle;
        ...
        public Vector3 Tilt { set { tilt = value; } get { return tilt; } }
        ...
        public float Angle
        {
            set
            {
                ...
                {
                    angle = newAngle;
                    if (onAngleChanged != null) onAngleChanged.Invoke(angle);
                }
            }
            get { return angle; }
        }
        ...
        public FloatEvent OnAngleChanged
        {
            get
            {
                if (onAngleChanged == null) onAngleChanged = new FloatEvent();
        ...
        [System.NonSerialized] private Canvas cachedCanvas;

        /// <summary>This method allows you to increase the <b>Angle</b> value from an external event (e.g. UI button click).</summary>
        public void IncrementAngle(float delta) { Angle += delta; }

#if UNITY_EDITOR
        protected virtual void OnDrawGizmosSelected() { Gizmos.DrawLine(transform.position, transform.TransformPoint(axis)); }
#endif
