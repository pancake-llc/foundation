...
namespace Lean.Touch
{
    ...
    public class LeanMultiHeld : MonoBehaviour
    {
        ...
        [System.Serializable]
        public class LeanFingerListEvent : UnityEvent<List<LeanFinger>>
        {
        }
        ...
        public int RequiredCount { set { requiredCount = value; } get { return requiredCount; } }

        [SerializeField] private int requiredCount = 2;

        /// <summary>The finger must be held for this many seconds.</summary>
        public float MinimumAge { set { minimumAge = value; } get { return minimumAge; } }

        [SerializeField] private float minimumAge = 1.0f;

        /// <summary>The finger cannot move more than this many pixels relative to the reference DPI.</summary>
        public float MaximumMovement { set { maximumMovement = value; } get { return maximumMovement; } }

        [SerializeField] private float maximumMovement = 5.0f;

        /// <summary>This event will be called if the above conditions are met when you begin holding fingers down.</summary>
        public LeanFingerListEvent OnFingersDown
        {
            get
            {
                if (onFingersDown == null) onFingersDown = new LeanFingerListEvent();
                return onFingersDown;
            }
        }
        ...
        /// <summary>This event will be called if the above conditions are met when you begin holding fingers down.</summary>
        public LeanFingerListEvent OnFingersUpdate
        {
            get
            {
                if (onFingersUpdate == null) onFingersUpdate = new LeanFingerListEvent();
                return onFingersUpdate;
            }
        }
        ...
        public LeanFingerListEvent OnFingersUp
        {
            get
            {
                if (onFingersUp == null) onFingersUp = new LeanFingerListEvent();
                return onFingersUp;
            }
        }
        ...
        public Vector3Event OnWorldDown
        {
            get
            {
                if (onWorldDown == null) onWorldDown = new Vector3Event();
                return onWorldDown;
            }
        }
        ...
        /// <summary>This event will be called if the above conditions are met when you first touch the screen.
        /// Vector3 = Finger position in world space.</summary>
        public Vector3Event OnWorldUpdate
        {
            get
            {
                if (onWorldUpdate == null) onWorldUpdate = new Vector3Event();
                return onWorldUpdate;
            }
        }
        ...
        /// <summary>This event will be called if the above conditions are met when you first touch the screen.
        /// Vector3 = Finger position in world space.</summary>
        public Vector3Event OnWorldUp
        {
            get
            {
                if (onWorldUp == null) onWorldUp = new Vector3Event();
                return onWorldUp;
            }
        }
        ...
        public Vector2Event OnScreenDown
        {
            get
            {
                if (onScreenDown == null) onScreenDown = new Vector2Event();
                return onScreenDown;
            }
        }
        ...
        /// <summary>This event will be called if the above conditions are met when you first touch the screen.
        /// Vector2 = Finger position in screen space.</summary>
        public Vector2Event OnScreenUpdate
        {
            get
            {
                if (onScreenUpdate == null) onScreenUpdate = new Vector2Event();
        ...
        /// <summary>This event will be called if the above conditions are met when you first touch the screen.
        /// Vector2 = Finger position in screen space.</summary>
        public Vector2Event OnScreenUp
        {
            get
            {
                if (onScreenUp == null) onScreenUp = new Vector2Event();
                return onScreenUp;
            }
        }
        ...
        [SerializeField] private List<LeanFinger> fingers = new List<LeanFinger>();

        // Additional finger data
        [SerializeField] private List<FingerData> fingerDatas = new List<FingerData>();
...
#if UNITY_EDITOR
        protected virtual void Reset() { requiredSelectable = GetComponentInParent<LeanSelectable>(); }
#endif
