...
namespace Lean.Touch
{
    ...
    public class LeanSelectableDrop : LeanSelectableByFingerBehaviour
    {
        ...
        [System.Serializable]
        public class IDropHandlerEvent : UnityEvent<IDropHandler>
        {
        }
        ...
        public IgnoreType Ignore { set { ignore = value; } get { return ignore; } }

        [SerializeField] private IgnoreType ignore = IgnoreType.ThisGameObjectAndAncestors;
        ...
        public GameObjectEvent OnGameObject
        {
            get
            {
                if (onGameObject == null) onGameObject = new GameObjectEvent();
                return onGameObject;
            }
        }
        ...
        public IDropHandlerEvent OnDropHandler
        {
            get
            {
                if (onDropHandler == null) onDropHandler = new IDropHandlerEvent();
        ...
        protected override void OnSelectedSelectFingerUp(LeanSelectByFinger select, LeanFinger finger)
        {
            ...
            var query = ScreenQuery.TryQuery(gameObject,
