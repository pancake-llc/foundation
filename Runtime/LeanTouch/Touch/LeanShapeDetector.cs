...
namespace Lean.Touch
{
    ...
    public class LeanShapeDetector : MonoBehaviour
    {
        ...
        public LeanShape Shape { set { shape = value; } get { return shape; } }

        [SerializeField] private LeanShape shape;
        ...
        public float DistanceThreshold { set { distanceThreshold = value; } get { return distanceThreshold; } }
        ...
        public float ErrorThreshold { set { errorThreshold = value; } get { return errorThreshold; } }

        [SerializeField] private float errorThreshold = 1.0f;
        ...
        public int MinimumPoints { set { minimumPoints = value; } get { return minimumPoints; } }

        [SerializeField] private int minimumPoints = -1;

        /// <summary>Which direction should the shape be checked using?</summary>
        public DirectionType Direction { set { direction = value; } get { return direction; } }

        [SerializeField] private DirectionType direction = DirectionType.ForwardAndBackward;
        ...
        public LeanFingerEvent OnDetected
        {
            get
            {
                if (onDetected == null) onDetected = new LeanFingerEvent();
                return onDetected;
            }
        }
        ...
        public void RemoveFinger(LeanFinger finger) { LeanFingerData.Remove(fingerDatas, finger, fingerDataPool); }

        /// <summary>If you've set Use to ManuallyAddedFingers, then you can call this method to manually remove all fingers.</summary>
        public void RemoveAllFingers() { LeanFingerData.RemoveAll(fingerDatas, fingerDataPool); }
        ...
        struct Line
        {
            ...
            public float GetFirstDistance(Vector2 point) { return Vector2.Distance(point, A); }
            ...
            public float GetDistance(Vector2 point)
            {
                ...
                if (c1 <= 0.0f) return Vector2.Distance(point, A);
                var c2 = Vector2.Dot(v, v);
                if (c2 <= c1) return Vector2.Distance(point, B);
                var b = c1 / c2;
                var Pb = A + b * v;
        ...
        private static bool CalculateMatch(
            List<Vector2> drawnShape,
            List<Vector2> referenceShape,
        ...
        private static Vector2 Read(List<Vector2> list, int index) { return list[(index % list.Count + list.Count) % list.Count]; }
