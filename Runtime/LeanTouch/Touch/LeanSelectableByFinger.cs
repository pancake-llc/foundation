...
namespace Lean.Touch
{
    ...
    public class LeanSelectableByFinger : LeanSelectable
    {
        ...
        [System.NonSerialized] private List<SelectedPair> selectingPairs = new List<SelectedPair>();
        ...
        public List<SelectedPair> SelectingPairs { get { return selectingPairs; } }
        ...
        public static List<LeanFinger> GetFingers(
            bool ignoreIfStartedOverGui,
            bool ignoreIfOverGui,
            int requiredFingerCount = 0,
