...
namespace Lean.Touch
{
    ...
    public static class LeanGesture
    {
        ...
        public static Vector2 GetScreenCenter() { return GetScreenCenter(LeanTouch.Fingers); }
        ...
        public static Vector2 GetLastScreenCenter() { return GetLastScreenCenter(LeanTouch.Fingers); }
        ...
        public static Vector2 GetStartScreenCenter() { return GetStartScreenCenter(LeanTouch.Fingers); }
        ...
        public static Vector2 GetScreenDelta() { return GetScreenDelta(LeanTouch.Fingers); }
        ...
        public static Vector2 GetScaledDelta() { return GetScreenDelta() * LeanTouch.ScalingFactor; }

        /// <summary>This returns a resolution-independent 'GetScreenDelta' value.</summary>
        public static Vector2 GetScaledDelta(List<LeanFinger> fingers) { return GetScreenDelta(fingers) * LeanTouch.ScalingFactor; }
        ...
        public static Vector3 GetWorldDelta(float distance, Camera camera = null) { return GetWorldDelta(LeanTouch.Fingers, distance, camera); }
        ...
        public static float GetScreenDistance() { return GetScreenDistance(LeanTouch.Fingers); }
        ...
        public static float GetScaledDistance() { return GetScreenDistance() * LeanTouch.ScalingFactor; }

        /// <summary>Gets the average ScreenPosition distance * LeanTouch.ScalingFactor between the fingers.</summary>
        public static float GetScaledDistance(List<LeanFinger> fingers) { return GetScreenDistance(fingers) * LeanTouch.ScalingFactor; }

        /// <summary>Gets the average ScreenPosition distance * LeanTouch.ScalingFactor between the fingers.</summary>
        public static float GetScaledDistance(List<LeanFinger> fingers, Vector2 center) { return GetScreenDistance(fingers, center) * LeanTouch.ScalingFactor; }
        ...
        public static float GetLastScreenDistance() { return GetLastScreenDistance(LeanTouch.Fingers); }
        ...
        public static float GetLastScaledDistance() { return GetLastScreenDistance() * LeanTouch.ScalingFactor; }

        /// <summary>Gets the last average ScreenPosition distance * LeanTouch.ScalingFactor between all fingers.</summary>
        public static float GetLastScaledDistance(List<LeanFinger> fingers) { return GetLastScreenDistance(fingers) * LeanTouch.ScalingFactor; }

        /// <summary>Gets the last average ScreenPosition distance * LeanTouch.ScalingFactor between all fingers.</summary>
        public static float GetLastScaledDistance(List<LeanFinger> fingers, Vector2 center) { return GetLastScreenDistance(fingers, center) * LeanTouch.ScalingFactor; }
        ...
        public static float GetStartScreenDistance() { return GetStartScreenDistance(LeanTouch.Fingers); }
        ...
        public static float GetStartScaledDistance() { return GetStartScreenDistance() * LeanTouch.ScalingFactor; }

        /// <summary>Gets the start average ScreenPosition distance * LeanTouch.ScalingFactor between all fingers.</summary>
        public static float GetStartScaledDistance(List<LeanFinger> fingers) { return GetStartScreenDistance(fingers) * LeanTouch.ScalingFactor; }

        /// <summary>Gets the start average ScreenPosition distance * LeanTouch.ScalingFactor between all fingers.</summary>
        public static float GetStartScaledDistance(List<LeanFinger> fingers, Vector2 center) { return GetStartScreenDistance(fingers, center) * LeanTouch.ScalingFactor; }
        ...
        public static float GetPinchScale(float wheelSensitivity = 0.0f) { return GetPinchScale(LeanTouch.Fingers, wheelSensitivity); }
        ...
        public static float GetPinchRatio(float wheelSensitivity = 0.0f) { return GetPinchRatio(LeanTouch.Fingers, wheelSensitivity); }
        ...
        public static float GetTwistDegrees() { return GetTwistDegrees(LeanTouch.Fingers); }

        /// <summary>Gets the average twist of the fingers in degrees.</summary>
        public static float GetTwistDegrees(List<LeanFinger> fingers) { return GetTwistRadians(fingers) * Mathf.Rad2Deg; }
        ...
        public static float GetTwistRadians() { return GetTwistRadians(LeanTouch.Fingers); }
