...
namespace Lean.Touch
{
    ...
    public class LeanGestureToggle : MonoBehaviour
    {
        ...
        public bool EnableWithoutIsolation { set { enableWithoutIsolation = value; } get { return enableWithoutIsolation; } }
        ...
        public MonoBehaviour DragComponent { set { dragComponent = value; } get { return dragComponent; } }

        [SerializeField] private MonoBehaviour dragComponent;

        /// <summary>The amount of drag required to enable dragging mode.</summary>
        public float DragThreshold { set { dragThreshold = value; } get { return dragThreshold; } }

        [SerializeField] private float dragThreshold = 50.0f;

        /// <summary>The component that will be enabled/disabled when pinching.</summary>
        public MonoBehaviour PinchComponent { set { pinchComponent = value; } get { return pinchComponent; } }

        [SerializeField] private MonoBehaviour pinchComponent;

        /// <summary>The amount of pinch required to enable twisting in scale (e.g. 0.1 = 0.9 to 1.1).</summary>
        public float PinchThreshold { set { pinchThreshold = value; } get { return pinchThreshold; } }
        ...
        public MonoBehaviour TwistComponent { set { twistComponent = value; } get { return twistComponent; } }

        [SerializeField] private MonoBehaviour twistComponent;

        /// <summary>The amount of twist required to enable twisting in degrees.</summary>
        public float TwistThreshold { set { twistThreshold = value; } get { return twistThreshold; } }

        [SerializeField] private float twistThreshold = 5.0f;

        /// <summary>Enable twist component when pinch component is activated?</summary>
        public bool TwistWithPinch { set { twistWithPinch = value; } get { return twistWithPinch; } }

        [SerializeField] private bool twistWithPinch;

        [System.NonSerialized] private StateType state;

        [System.NonSerialized] private Vector2 delta;

        [System.NonSerialized] private float scale = 1.0f;

        [System.NonSerialized] private float twist;
        ...
        protected virtual void Update()
        {
            ...
            {
                twistComponent.enabled = state == StateType.Twist || (enableWithoutIsolation == true && state == StateType.None) ||
                                         (twistWithPinch == true && state == StateType.Pinch);
            }
        }
    }
}
