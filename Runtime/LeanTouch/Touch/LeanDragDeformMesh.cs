...
namespace Lean.Touch
{
    ...
    public class LeanDragDeformMesh : MonoBehaviour
    {
        ...
        public float ScaledRadius { set { scaledRadius = value; } get { return scaledRadius; } }

        [SerializeField] private float scaledRadius = 50.0f;

        /// <summary>Should mesh deformation be applied to an attached MeshCollider?</summary>
        public bool ApplyToMeshCollider { set { applyToMeshCollider = value; } get { return applyToMeshCollider; } }

        [SerializeField] private bool applyToMeshCollider;
        ...
        [System.NonSerialized] private MeshFilter cachedMeshFilter;

        // The cached mesh collider
        [System.NonSerialized] private MeshCollider cachedMeshCollider;
