...
namespace Lean.Touch
{
    ...
    public class LeanMultiTap : MonoBehaviour
    {
        ...
        public IntEvent OnHighest
        {
            get
            {
                if (onHighest == null) onHighest = new IntEvent();
                return onHighest;
            }
        }
        ...
        /// Int = The maximum amount of fingers involved in this multi-tap.</summary>
        public IntIntEvent OnCountHighest
        {
            get
            {
                if (onCountHighest == null) onCountHighest = new IntIntEvent();
                return onCountHighest;
            }
        }

        [SerializeField] private IntIntEvent onCountHighest;
