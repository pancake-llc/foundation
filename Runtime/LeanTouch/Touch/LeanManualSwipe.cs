...
namespace Lean.Touch
{
    ...
    public class LeanManualSwipe : LeanSwipeBase
    {
        ...
        [System.NonSerialized] private List<LeanFinger> fingers;
        ...
        public void RemoveFinger(LeanFinger finger) { fingers.Remove(finger); }
        ...
        protected virtual void OnEnable() { LeanTouch.OnFingerSwipe += HandleFingerSwipe; }

        protected virtual void OnDisable() { LeanTouch.OnFingerSwipe -= HandleFingerSwipe; }
