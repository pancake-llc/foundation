...
namespace Lean.Touch
{
    ...
    public class LeanDragLine : LeanDragTrail
    {
        ...
        /// 0 = No change.</summary>
        public float WidthScale { set { widthScale = value; } get { return widthScale; } }

        [SerializeField] private float widthScale = 0.0f;

        /// <summary>The minimum length of the straight line in world space.
        /// -1 = Unrestricted.</summary>
        public float LengthMin { set { lengthMin = value; } get { return lengthMin; } }

        [SerializeField] private float lengthMin = -1.0f;

        /// <summary>The maximum length of the straight line in world space.
        /// -1 = Unrestricted.</summary>
        public float LengthMax { set { lengthMax = value; } get { return lengthMax; } }

        [SerializeField] private float lengthMax = -1.0f;

        /// <summary>Enable this if the line should begin from this Transform's position.</summary>
        public bool StartAtOrigin { set { startAtOrigin = value; } get { return startAtOrigin; } }

        [SerializeField] private bool startAtOrigin;
        ...
        public Vector3Event OnReleasedFrom
        {
            get
            {
                if (onReleasedFrom == null) onReleasedFrom = new Vector3Event();
                return onReleasedFrom;
            }
        }
        ...
        public Vector3Event OnReleasedDelta
        {
            get
            {
                if (onReleasedDelta == null) onReleasedDelta = new Vector3Event();
                return onReleasedDelta;
            }
        }
        ...
        [SerializeField] private Vector3Vector3Event onReleasedFromTo;
