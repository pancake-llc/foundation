...
namespace Lean.Touch
{
    ...
    public class LeanFinger
    {
        ...
        public bool IsActive { get { return LeanTouch.Fingers.Contains(this); } }
        ...
        public bool IsOverGui { get { return LeanTouch.PointOverGui(ScreenPosition); } }
        ...
        public Vector2 LastSnapshotScaledDelta { get { return LastSnapshotScreenDelta * LeanTouch.ScalingFactor; } }

        /// <summary>This will return how far in pixels the finger has moved since the last frame.</summary>
        public Vector2 ScreenDelta { get { return ScreenPosition - LastScreenPosition; } }

        /// <summary>This returns a resolution-independent 'ScreenDelta' value.</summary>
        public Vector2 ScaledDelta { get { return ScreenDelta * LeanTouch.ScalingFactor; } }
        ...
        public Vector2 SwipeScaledDelta { get { return SwipeScreenDelta * LeanTouch.ScalingFactor; } }
        ...
        public Ray GetRay(Camera camera = null)
        {
            ...
            camera = Pancake.C.GetCamera(camera);
        ...
        public Vector2 GetSnapshotScreenDelta(float deltaTime) { return ScreenPosition - GetSnapshotScreenPosition(Age - deltaTime); }

        /// <summary>This returns a resolution-independent 'GetSnapshotScreenDelta' value.</summary>
        public Vector2 GetSnapshotScaledDelta(float deltaTime) { return GetSnapshotScreenDelta(deltaTime) * LeanTouch.ScalingFactor; }
        ...
        public float GetRadians(Vector2 referencePoint) { return Mathf.Atan2(ScreenPosition.x - referencePoint.x, ScreenPosition.y - referencePoint.y); }
        ...
        public float GetLastRadians(Vector2 referencePoint) { return Mathf.Atan2(LastScreenPosition.x - referencePoint.x, LastScreenPosition.y - referencePoint.y); }

        /// <summary>This will return the angle between the last finger position and the reference point, relative to the screen.</summary>
        public float GetLastDegrees(Vector2 referencePoint) { return GetLastRadians(referencePoint) * Mathf.Rad2Deg; }
        ...
        public float GetDeltaRadians(Vector2 referencePoint) { return GetDeltaRadians(referencePoint, referencePoint); }
        ...
        /// <summary>This will return the delta angle between the last and current finger position relative to the reference point.</summary>
        public float GetDeltaDegrees(Vector2 referencePoint) { return GetDeltaRadians(referencePoint, referencePoint) * Mathf.Rad2Deg; }

        /// <summary>This will return the delta angle between the last and current finger position relative to the reference point and the last reference point.</summary>
        public float GetDeltaDegrees(Vector2 referencePoint, Vector2 lastReferencePoint) { return GetDeltaRadians(referencePoint, lastReferencePoint) * Mathf.Rad2Deg; }
        ...
        public float GetScaledDistance(Vector2 point) { return GetScreenDistance(point) * LeanTouch.ScalingFactor; }

        /// <summary>This will return the distance between the last finger and the reference point.</summary>
        public float GetLastScreenDistance(Vector2 point) { return Vector2.Distance(LastScreenPosition, point); }

        /// <summary>This returns a resolution-independent 'GetLastScreenDistance' value.</summary>
        public float GetLastScaledDistance(Vector2 point) { return GetLastScreenDistance(point) * LeanTouch.ScalingFactor; }

        /// <summary>This will return the distance between the start finger and the reference point.</summary>
        public float GetStartScreenDistance(Vector2 point) { return Vector2.Distance(StartScreenPosition, point); }

        /// <summary>This returns a resolution-independent 'GetStartScreenDistance' value.</summary>
        public float GetStartScaledDistance(Vector2 point) { return GetStartScreenDistance(point) * LeanTouch.ScalingFactor; }
        ...
        public Vector3 GetWorldDelta(float distance, Camera camera = null) { return GetWorldDelta(distance, distance, camera); }
