...
namespace Lean.Touch
{
    ...
    public class LeanShape : MonoBehaviour
    {
        ...
        public bool ConnectEnds { set { connectEnds = value; } get { return connectEnds; } }
        ...
        public LineRenderer Visual { set { visual = value; } get { return visual; } }
...
#if UNITY_EDITOR
        protected virtual void Start() { UpdateVisual(); }
#endif

#if UNITY_EDITOR
        protected virtual void OnValidate() { UpdateVisual(); }
#endif
    ...
    public class LeanShape_Editor : CwEditor
    {
        ...
        protected override void OnInspector()
        {
            ...
            if (drawing == true)
            {
                ...
                {
                    var point = points[i];
                    GUI.DrawTexture(new Rect(point.x - 7.0f, point.y - 7.0f, 14.0f, 14.0f),
        ...
        private static void Line(Vector2 a, Vector2 b, float thickness = 4.0f)
        {
            ...
            GUI.DrawTexture(new Rect(a.x, a.y, 1, 1),
                EditorGUIUtility.whiteTexture,
                ScaleMode.StretchToFill,
                true,
                0.0f,
