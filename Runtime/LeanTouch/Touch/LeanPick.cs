...
namespace Lean.Touch
{
    ...
    {
        [System.Serializable]
        public class LeanPickableEvent : UnityEvent<LeanPickable>
        {
        }
        ...
        public string RequiredTag { set { requiredTag = value; } get { return requiredTag; } }

        [SerializeField] private string requiredTag;

        /// <summary>This event will be invoked when an object is picked.</summary>
        public LeanPickableEvent OnPickable
        {
            get
            {
                if (onPickable == null) onPickable = new LeanPickableEvent();
                return onPickable;
            }
        }

        [SerializeField] private LeanPickableEvent onPickable;
        ...
        public void PickStartScreenPosition(LeanFinger finger) { SelectScreenPosition(finger, finger.StartScreenPosition); }

        /// <summary>This method allows you to pick at the finger's current <b>ScreenPosition</b>.
        /// NOTE: This method be called from somewhere for this component to work (e.g. LeanFingerTap).</summary>
        public void PickScreenPosition(LeanFinger finger) { SelectScreenPosition(finger, finger.ScreenPosition); }
