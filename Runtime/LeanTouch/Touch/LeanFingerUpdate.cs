...
namespace Lean.Touch
{
    ...
    public class LeanFingerUpdate : MonoBehaviour
    {
        ...
        protected virtual void OnEnable() { LeanTouch.OnFingerUpdate += HandleFingerUpdate; }

        protected virtual void OnDisable() { LeanTouch.OnFingerUpdate -= HandleFingerUpdate; }
