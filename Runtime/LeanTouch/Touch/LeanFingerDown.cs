...
namespace Lean.Touch
{
    ...
    public class LeanFingerDown : MonoBehaviour
    {
        ...
        protected virtual void OnDisable() { LeanTouch.OnFingerDown -= HandleFingerDown; }
...
namespace Lean.Touch.Editor
{
    ...
    {
        protected void DrawIgnore() { Draw("ignoreStartedOverGui", "Ignore fingers with StartedOverGui?"); }
