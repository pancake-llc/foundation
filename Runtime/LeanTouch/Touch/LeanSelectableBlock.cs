...
namespace Lean.Touch
{
    ...
    public class LeanSelectableBlock : LeanSelectableByFingerBehaviour
    {
        ...
        public float BlockSize { set { blockSize = value; } get { return blockSize; } }

        [SerializeField] private float blockSize = 2.5f;

        /// <summary>Auto deselect this block when swapping?</summary>
        public bool DeselectOnSwap { set { deselectOnSwap = value; } get { return deselectOnSwap; } }

        [SerializeField] private bool deselectOnSwap = true;
        ...
        protected virtual void Update()
        {
            ...
            if (Selectable != null && Selectable.IsSelected == true)
            {
                ...
                {
                    // Camera exists?
                    var camera = Pancake.C.GetCamera(null);
