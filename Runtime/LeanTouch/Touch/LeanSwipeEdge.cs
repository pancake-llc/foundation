...
namespace Lean.Touch
{
    ...
    public class LeanSwipeEdge : MonoBehaviour
    {
        ...
        public float AngleThreshold { set { angleThreshold = value; } get { return angleThreshold; } }

        [SerializeField] [Range(1.0f, 90.0f)] private float angleThreshold = 10.0f;

        /// <summary>The swipe must begin within this many scaled pixels of the edge of the screen.</summary>
        public float EdgeThreshold { set { edgeThreshold = value; } get { return edgeThreshold; } }
        ...
        public UnityEvent OnEdge
        {
            get
            {
                if (onEdge == null) onEdge = new UnityEvent();
                return onEdge;
            }
        }
        ...
        private bool CheckAngle(Vector2 a, Vector2 b) { return Vector2.Angle(a, b) <= angleThreshold; }

        private bool CheckEdge(float distance) { return Mathf.Abs(distance * LeanTouch.ScalingFactor) < edgeThreshold; }
    }
}
