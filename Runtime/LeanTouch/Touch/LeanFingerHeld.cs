...
namespace Lean.Touch
{
    ...
    public class LeanFingerHeld : MonoBehaviour
    {
        ...
        public LeanFingerEvent OnFingerDown
        {
            get
            {
                if (onFingerDown == null) onFingerDown = new LeanFingerEvent();
                return onFingerDown;
            }
        }

        [SerializeField] private LeanFingerEvent onFingerDown;

        /// <summary>Called on every frame the conditions are met.</summary>
        public LeanFingerEvent OnFingerUpdate
        {
            get
            {
                if (onFingerUpdate == null) onFingerUpdate = new LeanFingerEvent();
                return onFingerUpdate;
            }
        }

        [SerializeField] private LeanFingerEvent onFingerUpdate;
        ...
        public LeanFingerEvent OnFingerUp
        {
            get
            {
                if (onFingerUp == null) onFingerUp = new LeanFingerEvent();
                return onFingerUp;
            }
        }

        [SerializeField] private LeanFingerEvent onFingerUp;
        ...
        [SerializeField] protected List<FingerData> fingerDatas = new List<FingerData>();
