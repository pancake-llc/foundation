...
namespace Lean.Touch
{
    ...
    public class LeanReplayFinger : MonoBehaviour
    {
        ...
        public Transform Cursor { set { cursor = value; } get { return cursor; } }
        ...
        public bool Playing { set { playing = value; } get { return playing; } }

        [SerializeField] private bool playing;

        /// <summary>The position of the playback in seconds.</summary>
        public float PlayTime { set { playTime = value; } get { return playTime; } }
        ...
        public void StopReplay() { playing = false; }
