...
namespace Lean.Touch
{
    ...
    {
        [System.Serializable]
        public class GameObjectLeanFingerEvent : UnityEvent<GameObject, LeanFinger>
        {
        }
        ...
        public GameObjectLeanFingerEvent OnDropped
        {
            get
            {
                if (onDropped == null) onDropped = new GameObjectLeanFingerEvent();
                return onDropped;
            }
        }
