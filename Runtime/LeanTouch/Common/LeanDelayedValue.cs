...
namespace Lean.Common
{
    ...
    public class LeanDelayedValue : MonoBehaviour
    {
        ...
        public bool AutoClear { set { autoClear = value; } get { return autoClear; } }
        ...
        [SerializeField] private Queue<Snapshot> snapshots = new Queue<Snapshot>();

        [System.NonSerialized] private Vector3 pendingValue;

        [System.NonSerialized] private bool pendingSet;
