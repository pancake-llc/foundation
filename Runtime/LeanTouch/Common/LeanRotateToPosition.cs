...
namespace Lean.Common
{
    ...
    public class LeanRotateToPosition : MonoBehaviour
    {
        ...
        [SerializeField] private PositionType position;
        ...
        [SerializeField] private Vector3 previousDelta;

        private Transform FinalTransform { get { return target != null ? target : transform; } }
        ...
        public void ResetPosition() { previousPosition = FinalTransform.position; }

        protected virtual void Start() { ResetPosition(); }

        protected virtual void OnEnable() { ResetPosition(); }
