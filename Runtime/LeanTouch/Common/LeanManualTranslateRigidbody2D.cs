...
namespace Lean.Common
{
    ...
    public class LeanManualTranslateRigidbody2D : MonoBehaviour
    {
        ...
        public bool ResetVelocityInUpdate { set { resetVelocityInUpdate = value; } get { return resetVelocityInUpdate; } }

        [SerializeField] private bool resetVelocityInUpdate = true;

        [SerializeField] private Vector2 remainingDelta;
