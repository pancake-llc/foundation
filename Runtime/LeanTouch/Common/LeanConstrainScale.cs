...
namespace Lean.Common
{
    ...
    public class LeanConstrainScale : MonoBehaviour
    {
        ...
        public bool Minimum { set { minimum = value; } get { return minimum; } }

        [SerializeField] private bool minimum;

        /// <summary>The minimum transform.localScale value.</summary>
        public Vector3 MinimumScale { set { minimumScale = value; } get { return minimumScale; } }

        [SerializeField] private Vector3 minimumScale = Vector3.one;

        /// <summary>Should there be a maximum transform.localScale?</summary>
        public bool Maximum { set { maximum = value; } get { return maximum; } }

        [SerializeField] private bool maximum;

        /// <summary>The maximum transform.localScale value.</summary>
        public Vector3 MaximumScale { set { maximumScale = value; } get { return maximumScale; } }
        ...
        protected virtual void LateUpdate()
        {
            ...
            */
            ...
            if (Mathf.Approximately(oldScale.x, newScale.x) == false || Mathf.Approximately(oldScale.y, newScale.y) == false ||
