...
namespace Lean.Common
{
    ...
    public class LeanPath : MonoBehaviour
    {
        ...
        public Vector3 GetSmoothedPoint(float index)
        {
            ...
            p.x = CubicInterpolate(a.x,
                b.x,
                c.x,
                d.x,
                t);
            p.y = CubicInterpolate(a.y,
                b.y,
                c.y,
                d.y,
                t);
            p.z = CubicInterpolate(a.z,
                b.z,
                c.z,
                d.z,
                t);
        ...
        protected virtual void Update() { UpdateVisual(); }
