...
namespace Lean.Common
{
    ...
    public class LeanPitchYaw : MonoBehaviour
    {
        ...
        public void RotateToPosition(Vector3 point) { RotateToDirection(point - transform.position); }
        ...
        public void RotatePitch(float delta) { pitch -= delta * pitchSensitivity * GetSensitivity(); }

        public void RotateYaw(float delta) { yaw += delta * yawSensitivity * GetSensitivity(); }
