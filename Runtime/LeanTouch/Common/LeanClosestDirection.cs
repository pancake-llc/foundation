...
namespace Lean.Common
{
    ...
    public class LeanClosestDirection : MonoBehaviour
    {
        ...
        public IntEvent OnIndexChanged
        {
            get
            {
                if (onIndexChanged == null) onIndexChanged = new IntEvent();
                return onIndexChanged;
            }
        }

        [SerializeField] private IntEvent onIndexChanged;
        ...
        protected virtual void LateUpdate() { UpdateIndex(); }
