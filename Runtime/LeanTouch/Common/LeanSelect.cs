...
namespace Lean.Common
{
    ...
    public class LeanSelect : MonoBehaviour
    {
        ...
        public bool IsSelected(LeanSelectable selectable) { return selectables != null && selectables.Contains(selectable); }
        ...
        public void Select(LeanSelectable selectable) { TrySelect(selectable); }
        ...
        {
            if (Pancake.C.IsEnabled(selectable))
            {
        ...
        protected virtual void OnEnable() { instancesNode = Instances.AddLast(this); }
        ...
        protected virtual void OnDestroy() { DeselectAll(); }
    }
}
...
namespace Lean.Common.Editor
{
    ...
    public class LeanSelect_Editor : CwEditor
    {
        ...
        protected override void OnInspector()
        {
            ...
            var select = (LeanSelectable) UnityEditor.EditorGUILayout.ObjectField(new GUIContent("Select", "Drop a selectable object here to select it."),
                null,
                typeof(LeanSelectable),
                true);
            var deselect = (LeanSelectable) UnityEditor.EditorGUILayout.ObjectField(new GUIContent("Deselect", "Drop a selectable object here to deselect it."),
                null,
                typeof(LeanSelectable),
                true);
