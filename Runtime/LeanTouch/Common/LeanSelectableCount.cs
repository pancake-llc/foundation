...
namespace Lean.Common
{
    ...
    public class LeanSelectableCount : LeanSelectableBehaviour
    {
        ...
        public UnityEvent OnMatch
        {
            get
            {
                if (onMatch == null) onMatch = new UnityEvent();
                return onMatch;
            }
        }
        ...
        public UnityEvent OnUnmatch
        {
            get
            {
                if (onUnmatch == null) onUnmatch = new UnityEvent();
                return onUnmatch;
            }
        }
        ...
        protected override void OnSelected(LeanSelect select) { Count += 1; }

        protected override void OnDeselected(LeanSelect select) { Count = 0; }
