...
namespace Lean.Common
{
    ...
    public class LeanThresholdDelta : MonoBehaviour
    {
        ...
        public FloatEvent OnDeltaX
        {
            get
            {
                if (onDeltaX == null) onDeltaX = new FloatEvent();
                return onDeltaX;
            }
        }
        ...
        public FloatEvent OnDeltaY
        {
            get
            {
                if (onDeltaY == null) onDeltaY = new FloatEvent();
                return onDeltaY;
            }
        }
        ...
        public FloatEvent OnDeltaZ
        {
            get
            {
                if (onDeltaZ == null) onDeltaZ = new FloatEvent();
                return onDeltaZ;
            }
        }
        ...
        public Vector2Event OnDeltaXY
        {
            get
            {
                if (onDeltaXY == null) onDeltaXY = new Vector2Event();
                return onDeltaXY;
            }
        }
        ...
        public Vector3Event OnDeltaXYZ
        {
            get
            {
                if (onDeltaXYZ == null) onDeltaXYZ = new Vector3Event();
                return onDeltaXYZ;
            }
        }
