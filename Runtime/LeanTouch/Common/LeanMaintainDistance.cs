...
namespace Lean.Common
{
    ...
    public class LeanMaintainDistance : MonoBehaviour
    {
        ...
        public Space DirectionSpace { set { directionSpace = value; } get { return directionSpace; } }
        ...
        [SerializeField] private float clampMin = 1.0f;
        ...
        public LayerMask CollisionLayers { set { collisionLayers = value; } get { return collisionLayers; } }

        [SerializeField] private LayerMask collisionLayers;

        /// <summary>The radius of the collision.</summary>
        public float CollisionRadius { set { collisionRadius = value; } get { return collisionRadius; } }
        ...
        public void AddDistance(float value) { distance += value; }

        /// <summary>This method allows you to multiply the Distance value by the specified value.</summary>
        public void MultiplyDistance(float value) { distance *= value; }

        protected virtual void Start() { currentDistance = distance; }
