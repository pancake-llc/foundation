...
namespace Lean.Common
{
    ...
    public class LeanFormatString : MonoBehaviour
    {
        ...
        public void SetString(string a) { SendString(a); }

        /// <summary>This method will convert the input arguments into a formatted string, and output it to the <b>OnString</b> event.</summary>
        public void SetString(string a, string b) { SendString(a, b); }

        /// <summary>This method will convert the input arguments into a formatted string, and output it to the <b>OnString</b> event.</summary>
        public void SetString(int a) { SendString(a); }

        /// <summary>This method will convert the input arguments into a formatted string, and output it to the <b>OnString</b> event.</summary>
        public void SetString(int a, int b) { SendString(a, b); }

        /// <summary>This method will convert the input arguments into a formatted string, and output it to the <b>OnString</b> event.</summary>
        public void SetString(float a) { SendString(a); }

        /// <summary>This method will convert the input arguments into a formatted string, and output it to the <b>OnString</b> event.</summary>
        public void SetString(float a, float b) { SendString(a, b); }

        /// <summary>This method will convert the input arguments into a formatted string, and output it to the <b>OnString</b> event.</summary>
        public void SetString(Vector2 a) { SendString(a); }

        /// <summary>This method will convert the input arguments into a formatted string, and output it to the <b>OnString</b> event.</summary>
        public void SetString(Vector2 a, Vector2 b) { SendString(a, b); }

        /// <summary>This method will convert the input arguments into a formatted string, and output it to the <b>OnString</b> event.</summary>
        public void SetString(Vector3 a) { SendString(a); }

        /// <summary>This method will convert the input arguments into a formatted string, and output it to the <b>OnString</b> event.</summary>
        public void SetString(Vector3 a, Vector3 b) { SendString(a, b); }

        /// <summary>This method will convert the input arguments into a formatted string, and output it to the <b>OnString</b> event.</summary>
        public void SetString(Vector4 a) { SendString(a); }

        /// <summary>This method will convert the input arguments into a formatted string, and output it to the <b>OnString</b> event.</summary>
        public void SetString(Vector4 a, Vector4 b) { SendString(a, b); }

        /// <summary>This method will convert the input arguments into a formatted string, and output it to the <b>OnString</b> event.</summary>
        public void SetString(float a, int b) { SendString(a, b); }

        /// <summary>This method will convert the input arguments into a formatted string, and output it to the <b>OnString</b> event.</summary>
        public void SetString(int a, float b) { SendString(a, b); }
