...
namespace Lean.Common
{
    ...
    public class LeanSpawnBetween : MonoBehaviour
    {
        ...
        public float VelocityMultiplier { set { velocityMultiplier = value; } get { return velocityMultiplier; } }

        [SerializeField] private float velocityMultiplier = 1.0f;

        public float VelocityMin { set { velocityMin = value; } get { return velocityMin; } }
        [SerializeField] private float velocityMin = -1.0f;

        public float VelocityMax { set { velocityMax = value; } get { return velocityMax; } }
