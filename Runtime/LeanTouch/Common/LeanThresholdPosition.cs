...
namespace Lean.Common
{
    ...
    public class LeanThresholdPosition : MonoBehaviour
    {
        ...
        public FloatEvent OnPositionX
        {
            get
            {
                if (onPositionX == null) onPositionX = new FloatEvent();
                return onPositionX;
            }
        }
        ...
        public FloatEvent OnPositionY
        {
            get
            {
                if (onPositionY == null) onPositionY = new FloatEvent();
                return onPositionY;
            }
        }
        ...
        public FloatEvent OnPositionZ
        {
            get
            {
                if (onPositionZ == null) onPositionZ = new FloatEvent();
                return onPositionZ;
            }
        }
        ...
        public Vector2Event OnPositionXY
        {
            get
            {
                if (onPositionXY == null) onPositionXY = new Vector2Event();
                return onPositionXY;
            }
        }
        ...
        public Vector3Event OnPositionXYZ
        {
            get
            {
                if (onPositionXYZ == null) onPositionXYZ = new Vector3Event();
                return onPositionXYZ;
            }
        }
        ...
        /// <summary>This method allows you to set the <b>Current</b> position.</summary>
        public void SetXYZ(Vector3 position) { Current = position; }
