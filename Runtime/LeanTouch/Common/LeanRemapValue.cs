...
namespace Lean.Common
{
    ...
    public class LeanRemapValue : MonoBehaviour
    {
        ...
        public Vector3 OldMin { set { oldMin = value; } get { return oldMin; } }

        [SerializeField] private Vector3 oldMin;

        /// <summary>The range of the input values.</summary>
        public Vector3 OldMax { set { oldMax = value; } get { return oldMax; } }

        [SerializeField] private Vector3 oldMax = Vector3.one;

        /// <summary>The range of the output values.</summary>
        public Vector3 NewMin { set { newMin = value; } get { return newMin; } }

        [SerializeField] private Vector3 newMin;

        /// <summary>The range of the output values.</summary>
        public Vector3 NewMax { set { newMax = value; } get { return newMax; } }

        [SerializeField] private Vector3 newMax = Vector3.one;
        ...
        public void SetX(float x) { Remap(new Vector3(x, 0.0f, 0.0f)); }

        /// <summary>This method allows you to set the Y axis.</summary>
        public void SetY(float y) { Remap(new Vector3(0.0f, y, 0.0f)); }

        /// <summary>This method allows you to set the Z axis.</summary>
        public void SetZ(float z) { Remap(new Vector3(0.0f, 0.0f, z)); }

        /// <summary>This method allows you to set the XY axis.</summary>
        public void SetXY(Vector2 xy) { Remap(new Vector3(xy.x, xy.y, 0.0f)); }

        /// <summary>This method allows you to set the XYZ axis.</summary>
        public void SetXYZ(Vector3 xyz) { Remap(new Vector3(xyz.x, xyz.y, xyz.z)); }
