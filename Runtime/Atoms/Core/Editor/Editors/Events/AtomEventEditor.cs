...
namespace UnityAtoms.Editor
{
    ...
    public abstract class AtomEventEditor<T, E> : UnityEditor.Editor where E : AtomEvent<T>
    {
        public override VisualElement CreateInspectorGUI()
        {
            ...
            runtimeWrapper.Add(new Button(() => { atomEvent.Raise(atomEvent.InspectorRaiseValue); }) {text = "Raise"});
