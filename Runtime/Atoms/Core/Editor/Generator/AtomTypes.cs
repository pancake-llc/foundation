...
namespace UnityAtoms.Editor
{
    ...
    {
        public static readonly AtomType ACTION = new AtomType(displayName: "Action", templateName: "UA_Template__Action.txt");
        public static readonly AtomType PAIR_ACTION = new AtomType(displayName: "Pair Action", name: "Action", templateName: "UA_Template__Action.txt");

        public static readonly AtomType CONDITION_T = new AtomType(displayName: "Condition (T)",
            name: "Condition",
        ...
        public static readonly AtomType CONSTANT = new AtomType(displayName: "Constant",
        ...
        public static readonly AtomType PAIR_EVENT = new AtomType(displayName: "Pair Event",
            name: "Event",
            templateName: "UA_Template__Event.txt",
            drawerTemplateName: "UA_Template_AtomDrawer__Event.txt",
            editorTemplateName: "UA_Template_AtomEditor__Event.txt");
        ...
        public static readonly AtomType PAIR_EVENT_REFERENCE_LISTENER = new AtomType(displayName: "Pair Event Reference Listener",
        ...
        public static readonly AtomType REFERENCE = new AtomType(displayName: "Reference", templateName: "UA_Template__Reference.txt");

        // BASE_EVENT_REFERENCE is only used in thoses cases where a Variable does not make sense, eg. Void.
        public static readonly AtomType BASE_EVENT_REFERENCE = new AtomType(displayName: "Base Event Reference", templateName: "UA_Template__BaseEventReference.txt");
        public static readonly AtomType EVENT_REFERENCE = new AtomType(displayName: "Event Reference", templateName: "UA_Template__EventReference.txt");
        ...
        public static readonly AtomType SET_VARIABLE_VALUE = new AtomType(displayName: "Set Variable Value (string) => {}",
        ...
        public static readonly AtomType SYNC_VARIABLE_INSTANCER_TO_COLLECTION = new AtomType(displayName: "Sync Variable Instancer To Collection",
            templateName: "UA_Template__SyncVariableInstancerToCollection.txt",
            relativeFileNameAndPath: Path.Combine(Runtime.IsUnityAtomsRepo ? "Runtime" : "",
                "SyncVariableInstancerToCollection",
                $"Sync{{VALUE_TYPE_NAME}}VariableInstancerToCollection.cs"));

        public static readonly AtomType UNITY_EVENT = new AtomType(displayName: "Unity Event", templateName: "UA_Template__UnityEvent.txt");
        public static readonly AtomType PAIR_UNITY_EVENT = new AtomType(displayName: "Pair Unity Event", name: "UnityEvent", templateName: "UA_Template__UnityEvent.txt");
        ...
        public static readonly AtomType FUNCTION_T_T = new AtomType(displayName: "Function (T) => T",
            name: "Function",
        ...
        public static readonly AtomType EVENT_INSTANCER = new AtomType(displayName: "Event Instancer",
        ...
        public static readonly AtomType PAIR = new AtomType(displayName: "Pair", templateName: "UA_Template__Pair.txt");
        ...
        public static readonly Dictionary<AtomType, List<AtomType>> DEPENDENCY_GRAPH = new Dictionary<AtomType, List<AtomType>>()
        {
            ...
            {AtomTypes.VALUE_LIST, new List<AtomType>() {AtomTypes.EVENT}},
            {
                ...
                new List<AtomType>() {AtomTypes.EVENT, AtomTypes.BASE_EVENT_REFERENCE, AtomTypes.UNITY_EVENT, AtomTypes.ACTION}
            },
            {AtomTypes.EVENT_REFERENCE_LISTENER, new List<AtomType>() {AtomTypes.EVENT, AtomTypes.EVENT_REFERENCE, AtomTypes.UNITY_EVENT, AtomTypes.ACTION}},
            {
                AtomTypes.PAIR_EVENT_REFERENCE_LISTENER,
                new List<AtomType>() {AtomTypes.PAIR_EVENT, AtomTypes.PAIR_EVENT_REFERENCE, AtomTypes.PAIR_UNITY_EVENT, AtomTypes.PAIR_ACTION}
            },
            {
            ...
            {
                AtomTypes.PAIR_EVENT_REFERENCE,
                new List<AtomType>() {AtomTypes.VARIABLE, AtomTypes.PAIR_EVENT, AtomTypes.VARIABLE_INSTANCER, AtomTypes.PAIR_EVENT_INSTANCER}
            },
            {
            ...
            {AtomTypes.SYNC_VARIABLE_INSTANCER_TO_COLLECTION, new List<AtomType>() {AtomTypes.VARIABLE, AtomTypes.VARIABLE_INSTANCER}},
            ...
            {
                AtomTypes.VARIABLE_INSTANCER, new List<AtomType>()
                {
                    AtomTypes.VARIABLE,
                    AtomTypes.EVENT,
                    AtomTypes.PAIR_EVENT,
