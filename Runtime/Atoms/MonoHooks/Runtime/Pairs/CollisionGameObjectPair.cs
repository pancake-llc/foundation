...
namespace UnityAtoms.MonoHooks
{
    ...
    public struct CollisionGameObjectPair : IPair<CollisionGameObject>
    {
        ...
        [SerializeField] private CollisionGameObject _item1;
        [SerializeField] private CollisionGameObject _item2;

        public void Deconstruct(out CollisionGameObject item1, out CollisionGameObject item2)
        {
            item1 = Item1;
            item2 = Item2;
        }
