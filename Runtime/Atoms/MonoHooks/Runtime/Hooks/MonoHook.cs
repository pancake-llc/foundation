...
namespace UnityAtoms.MonoHooks
{
    ...
    public abstract class MonoHook<E, EV, ER, F> : MonoBehaviour where E : AtomEvent<EV> where ER : IGetEvent, ISetEvent where F : AtomFunction<GameObject, GameObject>
    {
        /// <summary>
        /// The Event
        /// </summary>
        ...
        [SerializeField] private ER _eventReference = default(ER);
        ...
        /// </summary>
        [SerializeField] protected F _selectGameObjectReference = default(F);
