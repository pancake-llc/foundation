...
namespace UnityAtoms.MonoHooks
{
    ...
    /// </summary>
    [Serializable]
    public sealed class Collider2DGameObjectPairEventReference : AtomEventReference<Collider2DGameObjectPair, Collider2DGameObjectVariable, Collider2DGameObjectPairEvent,
            Collider2DGameObjectVariableInstancer, Collider2DGameObjectPairEventInstancer>,
        IGetEvent
    {
    }
}
