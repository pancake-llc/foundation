...
namespace UnityAtoms.MonoHooks
{
    ...
    /// </summary>
    [Serializable]
    public sealed class ColliderGameObjectEventReference : AtomEventReference<ColliderGameObject, ColliderGameObjectVariable, ColliderGameObjectEvent,
            ColliderGameObjectVariableInstancer, ColliderGameObjectEventInstancer>,
        IGetEvent
    {
    }
}
