...
namespace UnityAtoms.MonoHooks
{
    ...
    /// </summary>
    [Serializable]
    public sealed class CollisionGameObjectEventReference : AtomEventReference<CollisionGameObject, CollisionGameObjectVariable, CollisionGameObjectEvent,
            CollisionGameObjectVariableInstancer, CollisionGameObjectEventInstancer>,
        IGetEvent
    {
    }
}
