...
namespace UnityAtoms.MonoHooks
{
    ...
    /// </summary>
    [Serializable]
    public sealed class Collider2DGameObjectEventReference : AtomEventReference<Collider2DGameObject, Collider2DGameObjectVariable, Collider2DGameObjectEvent,
            Collider2DGameObjectVariableInstancer, Collider2DGameObjectEventInstancer>,
        IGetEvent
    {
    }
}
