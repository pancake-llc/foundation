...
namespace UnityAtoms.MonoHooks
{
    ...
    public struct CollisionGameObject : IEquatable<CollisionGameObject>
    {
        ...
        public bool Equals(CollisionGameObject other) { return this.Collision == other.Collision && this.GameObject == other.GameObject; }
        ...
        /// <returns>`true` if equal, otherwise `false`.</returns>
        public static bool operator ==(CollisionGameObject first, CollisionGameObject second) { return first.Equals(second); }
