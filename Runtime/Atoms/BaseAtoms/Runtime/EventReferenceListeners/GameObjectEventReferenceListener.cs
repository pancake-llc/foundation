...
namespace UnityAtoms.BaseAtoms
{
    ...
    public sealed class GameObjectEventReferenceListener : AtomEventReferenceListener<GameObject, GameObjectEvent, GameObjectEventReference, GameObjectUnityEvent>
    {
    }
}
