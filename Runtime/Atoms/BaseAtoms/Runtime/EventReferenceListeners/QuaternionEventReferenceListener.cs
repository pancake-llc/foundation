...
namespace UnityAtoms.BaseAtoms
{
    ...
    public sealed class QuaternionEventReferenceListener : AtomEventReferenceListener<Quaternion, QuaternionEvent, QuaternionEventReference, QuaternionUnityEvent>
    {
    }
}
