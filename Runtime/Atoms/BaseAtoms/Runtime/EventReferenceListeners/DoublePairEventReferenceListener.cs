...
namespace UnityAtoms.BaseAtoms
{
    ...
    public sealed class DoublePairEventReferenceListener : AtomEventReferenceListener<DoublePair, DoublePairEvent, DoublePairEventReference, DoublePairUnityEvent>
    {
    }
}
