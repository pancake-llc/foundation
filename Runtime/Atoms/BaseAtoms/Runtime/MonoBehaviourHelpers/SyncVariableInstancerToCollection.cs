...
namespace UnityAtoms.BaseAtoms
{
    ...
    public class SyncVariableInstancerToCollection<T, V, VI> : MonoBehaviour where V : AtomBaseVariable<T> where VI : class, IVariable<V>
    {
        /// <summary>
        /// The Variable Instancer whose Variable will get synced to the List and / or Collection defined.
        /// </summary>
        [SerializeField] private VI _variableInstancer = default;
        ...
        /// </summary>
        [SerializeField] private AtomCollectionReference _syncToCollection = default;
        ...
        /// </summary>
        [SerializeField] private String _syncToCollectionKey = default;
        ...
        /// </summary>
        [SerializeField] private AtomListReference _syncToList = default;
        ...
        private void Start()
        {
            ...
            {
                _syncToCollection.GetValue()
                    .Add(String.IsNullOrWhiteSpace(_syncToCollectionKey) ? GetInstanceID().ToString() : _syncToCollectionKey, _variableInstancer.Variable);
            }
