...
namespace UnityAtoms.BaseAtoms
{
    ...
    /// </summary>
    [Serializable]
    public sealed class IntReference : EquatableAtomReference<int, IntPair, IntConstant, IntVariable, IntEvent, IntPairEvent, IntIntFunction, IntVariableInstancer>,
        IEquatable<IntReference>
    {
        public IntReference()
            : base()
        {
