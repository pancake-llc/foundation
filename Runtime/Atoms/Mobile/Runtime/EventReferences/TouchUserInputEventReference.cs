...
namespace UnityAtoms.Mobile
{
    ...
    /// </summary>
    [Serializable]
    public sealed class TouchUserInputEventReference : AtomEventReference<TouchUserInput, TouchUserInputVariable, TouchUserInputEvent, TouchUserInputVariableInstancer,
