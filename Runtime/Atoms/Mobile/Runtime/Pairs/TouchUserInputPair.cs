...
namespace UnityAtoms.Mobile
{
    ...
    public struct TouchUserInputPair : IPair<TouchUserInput>
    {
        ...
        [SerializeField] private TouchUserInput _item1;
        [SerializeField] private TouchUserInput _item2;

        public void Deconstruct(out TouchUserInput item1, out TouchUserInput item2)
        {
            item1 = Item1;
            item2 = Item2;
        }
