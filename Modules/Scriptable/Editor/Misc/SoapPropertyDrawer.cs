    ...
    public class SoapPropertyDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (targetObject == null)
            {
                ...
                {
                    if (Directory.Exists(PancakeEditor.Editor.DEFAULT_PATH_SCRIPTABLE_ASSET_GENERATED))
                        Directory.CreateDirectory(PancakeEditor.Editor.DEFAULT_PATH_SCRIPTABLE_ASSET_GENERATED);
                    ...
                    var creationPath = $"{PancakeEditor.Editor.DEFAULT_PATH_SCRIPTABLE_ASSET_GENERATED}/{instance.name}.asset";
