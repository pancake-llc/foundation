            ...
            switch (_bindText.type)
            {
                ...
                case CustomVariableType.Int:
                    ...
                    _bindText.increment = EditorGUILayout.IntField(new GUIContent("Increment",
                        ...
                        _bindText.increment);
                    _bindText.isClamped = EditorGUILayout.Toggle(new GUIContent("Is Clamped", "Clamps the value shown to a minimum and a maximum."), _bindText.isClamped);
