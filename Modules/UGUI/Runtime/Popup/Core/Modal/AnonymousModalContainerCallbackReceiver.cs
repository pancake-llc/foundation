...
namespace Pancake.UI.Popup
{
    public sealed class AnonymousModalContainerCallbackReceiver : IModalContainerCallbackReceiver
    {
        ...
        public void BeforePush(Modal enterModal, Modal exitModal) { OnBeforePush?.Invoke((enterModal, exitModal)); }

        public void AfterPush(Modal enterModal, Modal exitModal) { OnAfterPush?.Invoke((enterModal, exitModal)); }

        public void BeforePop(Modal enterModal, Modal exitModal) { OnBeforePop?.Invoke((enterModal, exitModal)); }

        public void AfterPop(Modal enterModal, Modal exitModal) { OnAfterPop?.Invoke((enterModal, exitModal)); }
    }
}