...
namespace Pancake.UI
{
    ...
    public class SimpleUITransitionAsset : UITransitionAsset
    {
        ...
        internal static SimpleUITransitionAsset CreateInstance(
            float? duration = null,
            Ease? easeType = null,
        ...
        {
            var anim = CreateInstance<SimpleUITransitionAsset>();
