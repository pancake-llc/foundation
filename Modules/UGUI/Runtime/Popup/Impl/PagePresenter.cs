...
namespace Pancake.UI
{
    public abstract class PagePresenter<TPage, TRootView, TRootViewState> : PagePresenter<TPage>, IDisposableCollectionHolder
        where TPage : Page<TRootView, TRootViewState> where TRootView : AppView<TRootViewState> where TRootViewState : AppViewState, new()
    {
        ...
        protected virtual Task ViewDidLoad(TPage view, TRootViewState viewState) { return Task.CompletedTask; }

        protected virtual Task ViewWillPushEnter(TPage view, TRootViewState viewState) { return Task.CompletedTask; }

        protected virtual void ViewDidPushEnter(TPage view, TRootViewState viewState) { }

        protected virtual Task ViewWillPushExit(TPage view, TRootViewState viewState) { return Task.CompletedTask; }

        protected virtual void ViewDidPushExit(TPage view, TRootViewState viewState) { }

        protected virtual Task ViewWillPopEnter(TPage view, TRootViewState viewState) { return Task.CompletedTask; }

        protected virtual void ViewDidPopEnter(TPage view, TRootViewState viewState) { }

        protected virtual Task ViewWillPopExit(TPage view, TRootViewState viewState) { return Task.CompletedTask; }

        protected virtual void ViewDidPopExit(TPage view, TRootViewState viewState) { }

        protected virtual Task ViewWillDestroy(TPage view, TRootViewState viewState) { return Task.CompletedTask; }
