...
namespace Pancake.UI
{
    public abstract class ModalPresenter<TModal, TRootView, TRootViewState> : ModalPresenter<TModal>, IDisposableCollectionHolder
        where TModal : Modal<TRootView, TRootViewState> where TRootView : AppView<TRootViewState> where TRootViewState : AppViewState, new()
    {
        private readonly List<IDisposable> _disposables = new List<IDisposable>();
        private TRootViewState _state;

        protected ModalPresenter(TModal view)
            : base(view)
        {
        }
        ...
        protected sealed override void Initialize(TModal view) { base.Initialize(view); }
        ...
        protected virtual Task ViewDidLoad(TModal view, TRootViewState viewState) { return Task.CompletedTask; }

        protected virtual Task ViewWillPushEnter(TModal view, TRootViewState viewState) { return Task.CompletedTask; }

        protected virtual void ViewDidPushEnter(TModal view, TRootViewState viewState) { }

        protected virtual Task ViewWillPushExit(TModal view, TRootViewState viewState) { return Task.CompletedTask; }

        protected virtual void ViewDidPushExit(TModal view, TRootViewState viewState) { }

        protected virtual Task ViewWillPopEnter(TModal view, TRootViewState viewState) { return Task.CompletedTask; }

        protected virtual void ViewDidPopEnter(TModal view, TRootViewState viewState) { }

        protected virtual Task ViewWillPopExit(TModal view, TRootViewState viewState) { return Task.CompletedTask; }

        protected virtual void ViewDidPopExit(TModal view, TRootViewState viewState) { }

        protected virtual Task ViewWillDestroy(TModal view, TRootViewState viewState) { return Task.CompletedTask; }
