...
namespace Pancake.UI
{
    public abstract class SheetPresenter<TSheet, TRootView, TRootViewState> : SheetPresenter<TSheet>, IDisposableCollectionHolder
        where TSheet : Sheet<TRootView, TRootViewState> where TRootView : AppView<TRootViewState> where TRootViewState : AppViewState, new()
    {
        ...
        protected virtual Task ViewDidLoad(TSheet view, TRootViewState viewState) { return Task.CompletedTask; }

        protected virtual Task ViewWillEnter(TSheet view, TRootViewState viewState) { return Task.CompletedTask; }

        protected virtual void ViewDidEnter(TSheet view, TRootViewState viewState) { }

        protected virtual Task ViewWillExit(TSheet view, TRootViewState viewState) { return Task.CompletedTask; }

        protected virtual void ViewDidExit(TSheet view, TRootViewState viewState) { }

        protected virtual Task ViewWillDestroy(TSheet view, TRootViewState viewState) { return Task.CompletedTask; }
