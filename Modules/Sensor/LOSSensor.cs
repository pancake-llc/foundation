...
namespace Pancake.Sensor
{
    ...
    public class LOSSensor : Sensor, IPulseRoutine
    {
        ...
        [Tooltip("When LimitViewAngle is true an object must be within this vertical view angle to be detected.")] [Range(0f, 90f)]
        ...
        protected override List<Collider> GetInputColliders(GameObject inputObject, List<Collider> storeIn) => InputSensor.GetDetectedColliders(inputObject, storeIn);
