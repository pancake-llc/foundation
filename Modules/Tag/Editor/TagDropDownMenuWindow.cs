...
{
    public class TagDropDownMenuWindow : EditorWindow
    {
        ...
        void OnEnable()
        {
            menu = ProjectDatabase.FindAssetWithPath<VisualTreeAsset>("TagMenuUI.uxml", TagEditorUtils.RELATIVE_PATH);
            menuCategory = ProjectDatabase.FindAssetWithPath<VisualTreeAsset>("TagMenuCategoryUI.uxml", TagEditorUtils.RELATIVE_PATH);
            menuItem = ProjectDatabase.FindAssetWithPath<VisualTreeAsset>("TagMenuItemUI.uxml", TagEditorUtils.RELATIVE_PATH);
            menuItemUSS = ProjectDatabase.FindAssetWithPath<StyleSheet>("TagMenuItemUI.uss", TagEditorUtils.RELATIVE_PATH);
        }
        ...
        public void Build(List<(string label, int idx, bool editable)> menuEntries, float windowWidth)
        {
            ...
            contentGroup.AddToClassList("tag-group");
